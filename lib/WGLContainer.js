...
import { hY as e$2, a2 as t$4, C as r$2, et as r$3, f8 as f, jz as r$5, iU as M$2, gu as t$5, iT as h$3, lb as b$1, i0 as i$1, z as i$2, bL as a$1, jQ as t$7, fe as f$1, s as s$6, ea as s$7, jA as f$2, eC as n$5, lc as K$1, gl as t$8, ld as J, br as r$8, bw as n$7, ad as l$5 } from "./index.js";
import { I, M as M$1, P, U, G, L, D, o as o$3, F, C, E as E$3, R, O as O$2, Y, V, B as B$2, _ as _$1, N as N$1 } from "./enums.js";
import { s as s$3 } from "./pixelUtils.js";
import { r as r$4, p as p$4, s as s$4, i as i$3 } from "./utils.js";
import { E as E$1 } from "./Texture.js";
import { E as E$2, a, s as s$5, x as x$4 } from "./VertexArrayObject.js";
import { t as t$6 } from "./VertexElementDescriptor.js";
import { E as A$2, a as at, B as B$1, C as C$1, F as D$1, G as E$4, H as F$1, K as G$1, L as K, M as L$1, o as o$4, Z, _ as _$2, $ } from "./definitions.js";
import { r as r$6 } from "./vec4f32.js";
import { g as ge, b as E$5, S as S$1, I as I$1 } from "./Utils2.js";
import { e as e$3, a as e$4 } from "./ProgramTemplate.js";
import { U as U$1, w, N, Z as Z$1, C as C$2, P as P$1 } from "./MaterialKey.js";
import { M as M$3, w as w$1 } from "./number.js";
import { r as r$7, l as l$4, n as n$6 } from "./StyleDefinition.js";
import { e as e$5 } from "./config.js";
...
class i extends t$3 {
  ...
  draw(s2, a2) {
    ...
    i2 && !l2.ready && r$2(r2) ? r2() : (this._visualState.time = s2.time / 1e3, this._visualState.dvsMat3 = a2.transforms.dvs, this._visualState.displayViewMat3 = s2.state.displayViewMat3, o2.flowStyle.render(s2, this._visualState, l2), o2.flowStyle.animated && r$2(r2) && r2());
  }
}
function m$9(e2, u2, m2 = "nearest", c2 = false) {
  var _a;
  const l2 = !(c2 && u2.pixelType === "u8"), _2 = l2 ? G.FLOAT : G.UNSIGNED_BYTE, p2 = u2.pixels == null || u2.pixels.length === 0 ? null : l2 ? u2.getAsRGBAFloat() : u2.getAsRGBA(), g2 = (_a = e2.capabilities.textureFloat) == null ? void 0 : _a.textureFloatLinear, T2 = { width: u2.width, height: u2.height, target: M$1.TEXTURE_2D, pixelFormat: P.RGBA, internalFormat: e2.type === r$3.WEBGL2 && l2 ? U.RGBA32F : P.RGBA, samplingMode: !g2 || m2 !== "bilinear" && m2 !== "cubic" ? L.NEAREST : L.LINEAR, dataType: _2, wrapMode: D.CLAMP_TO_EDGE, flipped: false };
  return new E$1(e2, T2, p2);
}
function c$5(e2, u2) {
  const { spacing: m2, offsets: c2, coefficients: l2, size: [_2, p2] } = u2, g2 = m2[0] > 1, T2 = { width: g2 ? 4 * _2 : _2, height: p2, target: M$1.TEXTURE_2D, pixelFormat: P.RGBA, internalFormat: e2.type === r$3.WEBGL2 ? U.RGBA32F : P.RGBA, dataType: G.FLOAT, samplingMode: L.NEAREST, wrapMode: D.CLAMP_TO_EDGE, flipped: false }, E2 = new Float32Array(g2 ? _2 * p2 * 16 : 2 * c2.length);
  if (g2)
...
function _(t2, n2, a2, r2 = 1, i2 = true) {
  return { u_flipY: i2, u_applyTransform: !!t2, u_opacity: r2, u_transformSpacing: t2 ? t2.spacing : f, u_transformGridSize: t2 ? t2.size : f, u_targetImageSize: n2, u_srcImageSize: a2 };
}
function p$3(e2, t2) {
...
class p$2 extends r$4 {
  ...
  setTransform(t2) {
    const o2 = r$5(this.transforms.dvs), [n2, h2] = t2.toScreenNoRotation([0, 0], [this.x, this.y]), l2 = this.resolution / this.pixelRatio / t2.resolution, d2 = l2 * this.width, _2 = l2 * this.height, m2 = Math.PI * this.rotation / 180;
    M$2(o2, o2, t$5(n2, h2)), M$2(o2, o2, t$5(d2 / 2, _2 / 2)), h$3(o2, o2, -m2), M$2(o2, o2, t$5(-d2 / 2, -_2 / 2)), b$1(o2, o2, t$5(d2, _2)), i$1(this.transforms.dvs, t2.displayViewMat3, o2);
  }
  getTextures() {
  ...
  _isValidSource(e2) {
    var _a;
    return r$2(e2) && ((_a = e2.pixels) == null ? void 0 : _a.length) > 0;
  }
  _getTextureSamplingMethod(e2) {
    const { type: r2, colormap: s2 } = this.symbolizerParameters, i2 = r2 === "lut" || r2 === "stretch" && r$2(s2);
  ...
  _updateColormapTexture(t2) {
    ...
    return r2 ? e2 ? r2.length !== e2.length || r2.some((t3, r3) => t3 !== e2[r3]) ? (this._colormapTexture && (this._colormapTexture.dispose(), this._colormapTexture = null), this._colormapTexture = l$3(t2, r2), void (this._colormap = r2)) : void 0 : (this._colormapTexture = l$3(t2, r2), void (this._colormap = r2)) : (this._colormapTexture && (this._colormapTexture.dispose(), this._colormapTexture = null), void (this._colormap = null));
  }
}
function T(e2) {
  return r$2(e2.source);
}
class n$4 {
  constructor(s2, n2) {
    this._rctx = s2, this._vertexBuffer = E$2.createVertex(s2, F.STATIC_DRAW, new Uint16Array(n2)), this._vao = new a(s2, new Map([["a_position", 0]]), { geometry: [new t$6("a_position", 2, C.SHORT, 0, 4)] }, { geometry: this._vertexBuffer }), this._count = n2.length / 2;
  }
  bind() {
...
class m$8 extends t$3 {
  ...
  _drawWithProgram({ context: t2, requestRender: s2, allowDelayedRender: a2 }, i2, p2, m2 = 1, f2 = [0, 0], _$12 = false) {
    if (this._quad || (this._quad = new n$4(t2, [0, 0, 1, 0, 0, 1, 1, 1])), a2 && r$2(s2) && !i2.isCompiled)
      return void s2();
    ...
    O$1(t2, i2, U2, j);
    const I2 = g$1(m2, f2), E$12 = _(b2, [P2, w2], [p2.source.width, p2.source.height], S2, _$12);
...
class d$4 extends t$3 {
  ...
  draw(t2, a2) {
    if (t$4(a2.source) || a2.source.validPixelCount === 0)
      return;
  ...
  _drawTriangles(e2, a2, r2, s2) {
    ...
    _2.setUniform4fv("u_colors", c$4[v2] || c$4.single_arrow), _2.setUniform2fv("u_dataRange", b2), _2.setUniform1f("u_rotation", S2), _2.setUniform2fv("u_symbolPercentRange", h2);
...
const o$2 = { nearest: { defines: [], samplingMode: L.NEAREST, mips: false }, bilinear: { defines: [], samplingMode: L.LINEAR, mips: false }, bicubic: { defines: ["bicubic"], samplingMode: L.LINEAR, mips: false }, trilinear: { defines: [], samplingMode: L.LINEAR_MIPMAP_LINEAR, mips: true } }, d$3 = (e2, t2, i2) => {
  if (i2.samplingMode === "dynamic") {
    ...
    return i3.rotation || r2 || n2 || t2.isSourceScaled || t2.rotation ? o$2.bilinear : o$2.nearest;
  }
  return o$2[i2.samplingMode];
};
class m$7 extends t$3 {
  constructor() {
  ...
  draw(s2, n2) {
    ...
    if (p2 && r$2(c2) && !f2.isCompiled)
      return void c2();
    s2.timeline.begin(this.name), n2.blendFunction === "additive" ? o2.setBlendFunctionSeparate(R.ONE, R.ONE, R.ONE, R.ONE) : o2.setBlendFunctionSeparate(R.ONE, R.ONE_MINUS_SRC_ALPHA, R.ONE, R.ONE_MINUS_SRC_ALPHA), o2.setStencilFunction(I.EQUAL, n2.stencilRef, 255), this._quad || (this._quad = new n$4(o2, [0, 0, 1, 0, 0, 1, 1, 1]));
...
class d$2 extends t$3 {
  constructor() {
    super(...arguments), this._color = r$6(0, 1, 0, 1);
  }
  dispose() {
  ...
  draw(t2, s2) {
    ...
    t$4(g2.indexBuffer) || (this._program || (this._program = e$4(o2, e)), d2 && r$2(m2) && !this._program.isCompiled ? m2() : (o2.useProgram(this._program), this._program.setUniform2fv("u_coord_range", [1, 1]), this._program.setUniform4fv("u_color", this._color), this._program.setUniformMatrix3fv("u_dvsMat3", a2.displayMat3), o2.bindVAO(g2), o2.drawElements(E$3.TRIANGLES, g2.indexBuffer.size, C.UNSIGNED_INT, 0), o2.bindVAO()));
  }
}
...
class p$1 extends t$3 {
  ...
  draw(e2, i2, s2) {
    ...
    t$4(a2) || (e2.timeline.begin(this.name), e2.attributeView.bindTextures(e2.context), e2.context.setStencilFunction(I.EQUAL, i2.stencilRef, 255), a2.forEachCommand((t2) => {
...
class c$2 extends p$1 {
  ...
  drawGeometry(o2, r2, i2, l2) {
    const { context: c2, painter: y2, rendererInfo: p2, requiredLevel: _2, passOptions: d2, requestRender: f2, allowDelayedRender: E2 } = o2, S2 = w.load(i2.materialKey), g2 = p$4(S2.data), N2 = r$2(d2) && d2.type === "hittest", T2 = y2.materialManager, { shader: I2, vertexLayout: U2, hittestAttributes: x2 } = i$2(g2.programSpec, u$2(S2));
    ...
    let w$12 = i2.indexCount, j = i2.indexFrom * Uint32Array.BYTES_PER_ELEMENT;
    N2 && (w$12 /= 3, j /= 3), c2.bindVAO(R2), this._drawFills(o2, r2, b2, L2, w$12, j);
  }
...
class O extends c$2 {
  ...
  dispose() {
    super.dispose(), this._disposeTextures(), this._dotFBO = a$1(this._dotFBO), this._dotVAO = a$1(this._dotVAO);
  }
  getGeometryType() {
    return E$5.FILL;
  }
  ...
  _drawDotLocations(e2, t2, o2, r2, s2) {
    ...
    const y2 = 1 / 2 ** (a2 - t2.key.level), g2 = o$4, S2 = g2 * window.devicePixelRatio * g2 * window.devicePixelRatio, E2 = 1 / y2 * (1 / y2), b2 = c2 ? e2.state.scale / c2 : 1;
    return o2.setUniform1f("u_tileZoomFactor", y2), o2.setUniform1f("u_tileDotsOverArea", S2 / (o$4 * window.devicePixelRatio * o$4 * window.devicePixelRatio)), o2.setUniformMatrix4fv("u_dotColors", f2), o2.setUniform4fv("u_isActive", T2), o2.setUniform4fv("u_dotBackgroundColor", p2), o2.setUniform1f("u_dotValue", Math.max(1, x2 * b2 * E2)), this._bindDotDensityTextures(i2, o2, d2, g2), i2.drawElements(E$3.TRIANGLES, r2, C.UNSIGNED_INT, s2), i2.setViewport(l2.x, l2.y, l2.width, l2.height), i2.bindFramebuffer(w2), D2.colorTexture;
  }
  _createFBO(e2) {
    if (t$4(this._dotFBO)) {
      const t2 = 512, o2 = 512, r2 = { target: M$1.TEXTURE_2D, pixelFormat: P.RGBA, dataType: G.UNSIGNED_BYTE, samplingMode: L.NEAREST, wrapMode: D.CLAMP_TO_EDGE, width: t2, height: o2 }, s2 = { colorTarget: Y.TEXTURE, depthStencilTarget: V.DEPTH_STENCIL_RENDER_BUFFER }, i2 = new s$5(e2, { width: t2, height: o2, internalFormat: B$2.DEPTH_STENCIL });
  ...
  _createDotDensityMesh(e2, t2, r2) {
    if (t$4(this._dotVAO)) {
      ...
      this._dotVAO = new a(e2, t2, r2, { geometry: i2 }, null);
    }
    return this._dotVAO;
  }
...
class u$1 extends p$1 {
  ...
  drawGeometry(o2, a2, i2, m2) {
    const { context: u2, painter: c2, rendererInfo: p2, state: y2, passOptions: _2, requestRender: f2, allowDelayedRender: E2 } = o2, S2 = N.load(i2.materialKey), N$12 = p$4(S2.data), T2 = r$2(_2) && _2.type === "hittest", { shader: g2, vertexLayout: x2, hittestAttributes: R2 } = i$2(N$12.programSpec, d$1);
...
function n$2(n2, i2) {
  const { textureFloat: f2, colorBufferFloat: s2 } = n2.capabilities, u2 = f2 == null ? void 0 : f2.textureFloat, m2 = f2 == null ? void 0 : f2.textureFloatLinear, _2 = f2 == null ? void 0 : f2.textureHalfFloat, p2 = f2 == null ? void 0 : f2.textureHalfFloatLinear, d2 = f2 == null ? void 0 : f2.HALF_FLOAT, x2 = s2 == null ? void 0 : s2.textureFloat, b2 = s2 == null ? void 0 : s2.textureHalfFloat, c2 = s2 == null ? void 0 : s2.floatBlend, { floatBufferBlendWorking: h2 } = f$1(n2.driverTest);
  if (!u2 && !_2)
    throw new s$6("heatmap:missing-texture-float", "HeatmapRenderer requires WebGL2 or the WebGL1 extension OES_texture_float or OES_texture_half_float.");
  if (!x2 && !b2)
    throw new s$6("heatmap:missing-color-buffer-float", "HeatmapRenderer requires the WebGL extension EXT_color_buffer_float or EXT_color_buffer_half_float or WEBGL_color_buffer_float.");
  if (!(c2 && h2 || b2))
    throw new s$6("heatmap:missing-float-blend", "HeatmapRenderer requires the WebGL extension EXT_float_blend or EXT_color_buffer_half_float." + (h2 ? "" : " This device claims support for EXT_float_blend, but does not actually support it."));
  ...
  throw new s$6("heatmap:missing-hardware-support", "HeatmapRenderer requires WebGL extensions that allow it to render and blend to float or half float textures.");
}
const S = s$7.getLogger("esri.views.2d.engine.webgl.brushes.WGLBrushHeatmap");
function x$2(e2) {
...
class y extends t$1 {
  ...
  dispose() {
    this._prevFBO = null, this._accumulateOutputTexture = a$1(this._accumulateOutputTexture), r$2(this._accumulateFramebuffer) && this._accumulateFramebuffer.detachDepthStencilBuffer(), this._accumulateOutputStencilBuffer = a$1(this._accumulateOutputStencilBuffer), this._accumulateFramebuffer = a$1(this._accumulateFramebuffer), this._resolveGradientTexture = a$1(this._resolveGradientTexture), this._tileQuad = a$1(this._tileQuad);
  }
  bind(e2) {
    const { context: t2, rendererInfo: i2, passOptions: a2 } = e2, { rendererSchema: s2 } = i2;
    !(r$2(a2) && a2.type === "hittest") && x$2(s2) && (this._prevFBO = t2.getBoundFramebufferObject(), this._prevViewport = t2.getViewport(), s$4(s2, "heatmap"), this._loadResources(e2), this._updateResources(t2, s2), t2.bindFramebuffer(this._accumulateFramebuffer), t2.setViewport(0, 0, this._accumulateFramebuffer.width, this._accumulateFramebuffer.height), t2.setStencilTestEnabled(true), t2.setBlendingEnabled(true), t2.setBlendFunction(R.ONE, R.ONE), t2.setClearColor(0, 0, 0, 0), t2.clear(_$1.COLOR_BUFFER_BIT));
  }
  unbind() {
  ...
  draw(e2) {
    ...
    if (r$2(s2) && s2.type === "hittest" || !x$2(u2))
      return;
  ...
  _loadResources({ context: e2, painter: t2 }) {
    ...
    (_a = this._accumulateOutputTexture) != null ? _a : this._accumulateOutputTexture = new E$1(e2, { target: M$1.TEXTURE_2D, pixelFormat: a2, internalFormat: u2, dataType: r2, samplingMode: i2, wrapMode: D.CLAMP_TO_EDGE, width: l2, height: f2 }), o2 || ((_b = this._accumulateOutputStencilBuffer) != null ? _b : this._accumulateOutputStencilBuffer = new s$5(e2, { width: l2, height: f2, internalFormat: B$2.DEPTH_STENCIL })), (_c = this._accumulateFramebuffer) != null ? _c : this._accumulateFramebuffer = new x$4(e2, {}, this._accumulateOutputTexture, o2 ? t2.getSharedStencilBuffer() : this._accumulateOutputStencilBuffer), (_d = this._resolveGradientTexture) != null ? _d : this._resolveGradientTexture = new E$1(e2, { target: M$1.TEXTURE_2D, pixelFormat: P.RGBA, dataType: G.UNSIGNED_BYTE, samplingMode: L.LINEAR, wrapMode: D.CLAMP_TO_EDGE }), (_e = this._tileQuad) != null ? _e : this._tileQuad = new n$4(e2, [0, 0, 1, 0, 0, 1, 1, 1]);
  }
  _updateResources(e2, t2) {
    ...
    u2 || e2.blitFramebuffer(this._prevFBO, this._accumulateFramebuffer, 0, 0, this._prevFBO.width, this._prevFBO.height, 0, 0, this._accumulateFramebuffer.width, this._accumulateFramebuffer.height, _$1.STENCIL_BUFFER_BIT, L.NEAREST);
  }
  loadQualityProfile(e2) {
    if (t$4(this._qualityProfile)) {
      const t2 = n$2(e2, S), r2 = e2.type === r$3.WEBGL1;
...
const r$1 = { geometry: [new t$6("a_pos", 2, C.BYTE, 0, 2)] }, t = { geometry: [new t$6("a_pos", 2, C.BYTE, 0, 4), new t$6("a_tex", 2, C.BYTE, 2, 4)] }, m$5 = { geometry: [new t$6("a_pos", 2, C.UNSIGNED_SHORT, 0, 4)] };
...
const A = 300, b = 32;
class x$1 extends t$3 {
  constructor() {
    super(...arguments), this._color = r$6(1, 0, 0, 1);
  }
  dispose() {
  ...
  draw(e2, r2) {
    ...
    if (!r2.isReady)
      return;
    if (this._loadWGLResources(i2), s2 && r$2(o2) && (!this._outlineProgram.isCompiled || !this._tileInfoProgram.isCompiled))
      return void o2();
  ...
  _loadWGLResources(t2) {
    if (this._outlineProgram && this._tileInfoProgram)
      return;
    const e$12 = e$4(t2, e), i2 = e$4(t2, r), a$12 = new Int8Array([0, 0, 1, 0, 1, 1, 0, 1]), l2 = E$2.createVertex(t2, F.STATIC_DRAW, a$12), m2 = new a(t2, e.attributes, r$1, { geometry: l2 }), _2 = new Int8Array([0, 0, 1, 0, 0, 1, 1, 1]), f2 = E$2.createVertex(t2, F.STATIC_DRAW, _2), h2 = new a(t2, r.attributes, r$1, { geometry: f2 });
...
class s$2 extends u$1 {
  ...
  _drawMarkers(o2, r2, s2, n2, l2, f2, u2) {
    ...
    s$4(a2, "pie-chart"), s2.setUniform4fv("u_colors", a2.colors), s2.setUniform4fv("u_defaultColor", a2.defaultColor), s2.setUniform4fv("u_othersColor", a2.othersColor), s2.setUniform4fv("u_outlineColor", a2.outlineColor), s2.setUniform1f("u_donutRatio", a2.holePercentage), s2.setUniform1f("u_sectorThreshold", a2.sectorThreshold), s2.setUniform1f("u_outlineWidth", a2.outlineWidth), i2.drawElements(n2, l2, C.UNSIGNED_INT, f2);
  }
}
class h$1 extends t$3 {
  constructor() {
    super(...arguments), this._color = r$6(1, 0, 0, 1), this._initialized = false;
  }
  dispose() {
  ...
  _initialize(r2) {
    ...
    if (!e$12)
      return false;
    const i2 = new Int8Array([0, 0, 1, 0, 0, 1, 1, 1]), a$12 = E$2.createVertex(r2, F.STATIC_DRAW, i2), l2 = new a(r2, e.attributes, r$1, { geometry: a$12 });
    return this._solidProgram = e$12, this._solidVertexArrayObject = l2, this._initialized = true, true;
  }
}
class d extends t$3 {
  constructor() {
    super(...arguments), this._color = r$6(1, 0, 0, 1), this._patternMatrix = e$2(), this._programOptions = { id: false, pattern: false };
  }
  dispose() {
  ...
  drawMany(e2, o2) {
    ...
    let A2, P2;
    const I$2 = w2 > _$2 ? 2 : 1, R2 = e2.drawPhase === I$1.HITTEST, k = this._programOptions;
    k.id = R2, k.pattern = j;
    const T2 = y2.getMaterialProgram(c2, v2, k);
    if (d2 && r$2(_2) && !T2.isCompiled)
      _2();
    else {
      if (c2.bindVAO(this._vao), c2.useProgram(T2), j) {
        ...
        if (r$2(t2)) {
          ...
          r$2(a2) && (L$12.bind(c2, L.LINEAR, s2, Z), T2.setUniform4f("u_tlbr", e3[0], e3[1], o3[0], o3[1]), T2.setUniform2fv("u_mosaicSize", a2), T2.setUniform1i("u_texture", Z));
        }
      ...
      for (const r2 of o2) {
        if (T2.setUniform1f("u_coord_range", r2.rangeX), T2.setUniformMatrix3fv("u_dvsMat3", r2.transforms.dvs), j) {
          const e3 = Math.max(2 ** (Math.round(h2) - r2.key.level), 1), o3 = I$2 * r2.width * e3, i2 = o3 / f$2(A2), s2 = o3 / f$2(P2);
  ...
  _loadWGLResources(t2) {
    if (this._vao)
      return;
    const { context: r2, styleLayer: e2 } = t2, o2 = e2.backgroundMaterial, i2 = new Int8Array([0, 0, 1, 0, 0, 1, 1, 1]), s2 = E$2.createVertex(r2, F.STATIC_DRAW, i2), a$12 = new a(r2, o2.getAttributeLocations(), o2.getLayoutInfo(), { geometry: s2 });
    this._vao = a$12;
  }
}
class c$1 extends t$3 {
  constructor() {
...
class m$4 extends t$3 {
  ...
  _drawFill(o2, l2, m2, p2, y2, g2, _2, E2, v2, M2) {
    if (_2 && !v2 && t$4(E2))
      return;
    const { context: P2, displayLevel: I$2, state: T2, drawPhase: U2, painter: x2, pixelRatio: D2, spriteMosaic: h2, requestRender: S2, allowDelayedRender: R2 } = o2, w2 = m2.fillMaterial, N2 = x2.vectorTilesMaterialManager, L$12 = D2 > _$2 ? 2 : 1, A2 = U2 === I$1.HITTEST, C$12 = this._fillProgramOptions;
    C$12.id = A2, C$12.pattern = _2;
    const V2 = N2.getMaterialProgram(P2, w2, C$12);
    if (R2 && r$2(S2) && !V2.isCompiled)
      return void S2();
    if (P2.useProgram(V2), r$2(E2)) {
      const { page: t2 } = E2, i2 = h2.getPageSize(t2);
      r$2(i2) && (h2.bind(P2, L.LINEAR, t2, Z), V2.setUniform2fv("u_mosaicSize", i2), V2.setUniform1i("u_texture", Z));
    }
      ...
      if (!t$4(n2)) {
        ...
        if (v2) {
          ...
          for (const [i3, a3] of t2) {
            ...
            r$2(t3) && (h2.bind(P2, L.LINEAR, i3, Z), V2.setUniform2fv("u_mosaicSize", t3), V2.setUniform1i("u_texture", Z), P2.drawElements(E$3.TRIANGLES, a3[1], C.UNSIGNED_INT, Uint32Array.BYTES_PER_ELEMENT * a3[0]));
          }
        } else
  ...
  _drawOutline(r2, a2, o2, l2, s2, m2, p2) {
    ...
    for (const e2 of l2) {
      ...
      t$4(r3) || (y2.bindVAO(r3), R2.setUniformMatrix3fv("u_dvsMat3", e2.transforms.dvs), y2.setStencilFunction(I.EQUAL, e2.stencilRef, 255), y2.drawElements(E$3.TRIANGLES, i2.outlineIndexCount, C.UNSIGNED_INT, Uint32Array.BYTES_PER_ELEMENT * i2.outlineIndexStart), e2.triangleCount += i2.outlineIndexCount / 3);
    }
  }
}
class u extends t$3 {
  ...
  drawMany(o2, u2) {
    ...
    if (R2 && r$2(R2)) {
      ...
      r$2(i2) && (M2.bind(c2, L.LINEAR, t2, Z), b2.setUniform2fv("u_mosaicSize", i2), b2.setUniform1i("u_texture", Z));
    }
    let z = -1;
    for (const i2 of u2) {
      ...
      if (!t$4(o3)) {
        if (c2.bindVAO(o3), b2.setUniformMatrix3fv("u_dvsMat3", i2.transforms.dvs), c2.setStencilFunction(I.EQUAL, i2.stencilRef, 255), N2 || h2) {
          ...
          for (const [i3, r3] of t2) {
            ...
            r$2(t3) && (M2.bind(c2, L.LINEAR, i3, Z), b2.setUniform2fv("u_mosaicSize", t3), b2.setUniform1i("u_texture", Z), c2.drawElements(E$3.TRIANGLES, r3[1], C.UNSIGNED_INT, Uint32Array.BYTES_PER_ELEMENT * r3[0]));
          }
        } else
...
class M extends t$3 {
  constructor() {
    super(...arguments), this._iconProgramOptions = { id: false, sdf: false }, this._sdfProgramOptions = { id: false }, this._spritesTextureSize = n$5();
  }
  dispose() {
  }
  drawMany(e2, t2) {
  ...
  _drawIcons(i2, a2, f2, p2) {
    ...
    R2 === l$4.AUTO && (R2 = a2.getLayoutValue("symbol-placement", d2) === n$6.POINT ? l$4.VIEWPORT : l$4.MAP);
    const S2 = R2 === l$4.MAP, V2 = a2.getLayoutValue("icon-keep-upright", d2) && S2, w2 = x2.isIconSDF, A2 = y2 === I$1.HITTEST, L2 = this._iconProgramOptions;
    L2.id = A2, L2.sdf = w2;
    const O2 = E2.getMaterialProgram(c2, U2, L2);
    if (T2 && r$2(P2) && !O2.isCompiled)
      return void P2();
    c2.useProgram(O2), O2.setUniformMatrix3fv("u_displayViewMat3", R2 === l$4.MAP ? h2.displayViewMat3 : h2.displayMat3), O2.setUniformMatrix3fv("u_displayMat3", I2 === r$7.VIEWPORT ? h2.displayMat3 : h2.displayViewMat3), O2.setUniform2fv("u_iconTranslation", D2), O2.setUniform1f("u_depth", a2.z), O2.setUniform1f("u_mapRotation", M$4(h2.rotation)), O2.setUniform1f("u_keepUpright", V2 ? 1 : 0), O2.setUniform1f("u_level", 10 * d2), O2.setUniform1i("u_texture", Z), O2.setUniform1f("u_fadeDuration", e$5 / 1e3), A2 && O2.setUniform4fv("u_id", p2);
    let N2 = -1;
    for (const e2 of f2) {
  ...
  _drawText(i2, l2, p2, c2) {
    ...
    k === l$4.AUTO && (k = l2.getLayoutValue("symbol-placement", g2) === n$6.POINT ? l$4.VIEWPORT : l$4.MAP);
    const j = k === l$4.MAP, G2 = l2.getLayoutValue("text-keep-upright", g2) && j, W = _2 === I$1.HITTEST, C2 = 0.8 * z / T2;
    this._glyphTextureSize || (this._glyphTextureSize = t$5(M2.width / 4, M2.height / 4));
...
class m$2 extends p$1 {
  ...
  drawGeometry(t2, o2, a2, m2) {
    const { context: l2, painter: c2, rendererInfo: u2, displayLevel: p2, passOptions: d2, requestRender: y2, allowDelayedRender: _2 } = t2, f2 = C$2.load(a2.materialKey), E2 = r$2(d2) && d2.type === "hittest";
...
class m$1 extends p$1 {
  ...
  drawGeometry(e2, o2, a2, m2) {
    const { context: l2, painter: p2, rendererInfo: u2, state: d2, passOptions: y2, requestRender: _2, allowDelayedRender: c2 } = e2, f2 = P$1.load(a2.materialKey), E2 = r$2(y2) && y2.type === "hittest", { bufferLayouts: N2, attributes: S2 } = s(f2), T2 = p2.materialManager.getMaterialProgram(e2, f2, "materials/text", S2, m2);
    if (c2 && r$2(_2) && !T2.isCompiled)
      return void _2();
    l2.useProgram(T2);
...
const n$1 = { marker: u$1, line: m$2, fill: c$2, text: m$1, label: l$1, clip: d$2, stencil: h$1, bitmap: m$7, overlay: u$3, raster: m$8, rasterVF: d$4, flow: i, tileInfo: x$1, vtlBackground: d, vtlFill: m$4, vtlLine: u, vtlCircle: c$1, vtlSymbol: M, dotDensity: O, heatmap: B, pieChart: s$2 };
const x = (t2) => {
...
class l {
  ...
  static fromPath(e2) {
    const t2 = K$1(new t$8(), e2.path, false, false), r2 = t2.coords, s2 = new Uint32Array(p(t2, true)), o2 = new Uint32Array(r2.length / 2);
    for (let n2 = 0; n2 < o2.length; n2++)
      o2[n2] = w$1(Math.floor(r2[2 * n2]), Math.floor(r2[2 * n2 + 1]));
  ...
  static fromGeometry(r2, s2) {
    ...
    switch (o2) {
      ...
      default:
        return s$7.getLogger("esri.views.2d.engine.webgl.Mesh2D").error(new s$6("mapview-bad-type", `Unable to create a mesh from type ${o2}`, s2)), l.fromRect({ x: 0, y: 0, width: 1, height: 1 });
    }
  }
  static fromPolygon(e2, t2) {
    const r2 = J(new t$8(), t2, false, false), s2 = r2.coords, i2 = new Uint32Array(p(r2, false)), h2 = new Uint32Array(s2.length / 2), u2 = n$7(), y2 = n$7();
    for (let n2 = 0; n2 < h2.length; n2++)
      r$8(u2, s2[2 * n2], s2[2 * n2 + 1]), e2.toScreen(y2, u2), h2[n2] = w$1(Math.floor(y2[0]), Math.floor(y2[1]));
    return new l({ geometry: h2 }, i2, E$3.TRIANGLES, true);
  }
  static fromScreenExtent({ xmin: e2, xmax: t2, ymin: r2, ymax: s2 }) {
    const o2 = { geometry: new Uint32Array([w$1(e2, r2), w$1(t2, r2), w$1(e2, s2), w$1(e2, s2), w$1(t2, r2), w$1(t2, s2)]) }, n2 = new Uint32Array([0, 1, 2, 3, 4, 5]);
    return new l(o2, n2, E$3.TRIANGLES);
  }
  static fromMapExtent(e2, t2) {
    const [r2, s2] = e2.toScreen([0, 0], [t2.xmin, t2.ymin]), [o2, n2] = e2.toScreen([0, 0], [t2.xmax, t2.ymax]), i2 = { geometry: new Uint32Array([w$1(r2, s2), w$1(o2, s2), w$1(r2, n2), w$1(r2, n2), w$1(o2, s2), w$1(o2, n2)]) }, c2 = new Uint32Array([0, 1, 2, 3, 4, 5]);
    return new l(i2, c2, E$3.TRIANGLES);
  }
  destroy() {
    r$2(this._cache.indexBuffer) && this._cache.indexBuffer.dispose();
    for (const e2 in this._cache.vertexBuffers)
      r$2(this._cache.vertexBuffers[e2]) && this._cache.vertexBuffers[e2].dispose();
  }
  get elementType() {
...
class m extends r$4 {
  constructor(t2, e2) {
    super(), this._clip = e2, this._cache = {}, this.stage = t2, this._handle = l$5(() => e2.version, () => this._invalidate()), this.ready();
  }
  static fromClipArea(t2, e2) {
    return new m(t2, e2);
  }
  _destroyGL() {
    r$2(this._cache.mesh) && (this._cache.mesh.destroy(), this._cache.mesh = null), r$2(this._cache.vao) && (this._cache.vao.dispose(), this._cache.vao = null);
  }
  destroy() {
  ...
  getVAO(t2, e2, r2, i2) {
    const [o2, h2] = e2.size;
    if (this._clip.type !== "geometry" && this._lastWidth === o2 && this._lastHeight === h2 || (this._lastWidth = o2, this._lastHeight = h2, this._destroyGL()), t$4(this._cache.vao)) {
      const s2 = this._createMesh(e2, this._clip), o3 = s2.getIndexBuffer(t2), h3 = s2.getVertexBuffers(t2);
      this._cache.mesh = s2, this._cache.vao = new a(t2, r2, i2, h3, o3);
    }
  ...
  _createMesh(r2, s2) {
    switch (s2.type) {
      ...
      default:
        return s$7.getLogger("esri.views.2d.engine.webgl.ClippingInfo").error(new s$6("mapview-bad-type", "Unable to create ClippingInfo mesh from clip of type: ${clip.type}")), l.fromRect({ x: 0, y: 0, width: 1, height: 1 });
    }
  }
}
class o extends i$3 {
  ...
  renderChildren(r2) {
    t$4(this._renderPasses) && (this._renderPasses = this.prepareRenderPasses(r2.painter));
  ...
  _updateClippingInfo() {
    if (r$2(this._clippingInfos) && (this._clippingInfos.forEach((e3) => e3.destroy()), this._clippingInfos = null), !this.stage)
      return;
    const e2 = this._clips;
    r$2(e2) && e2.length && (this._clippingInfos = e2.items.map((e3) => m.fromClipArea(this.stage, e3))), this.requestRender();
  }
}
export { n$4 as a, t$1 as b, n$1 as c, d$4 as d, c$5 as e, h$1 as h, i, m$5 as m, n$3 as n, o, p$2 as p, t, x$1 as x };
