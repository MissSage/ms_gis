import { p6 as G, bm as f, kD as c$1, kA as t, fe as f$1, fK as u, p7 as p, U, bj as l, p8 as m, p9 as r } from "./index.js";
import { s, i as ie, b as oe, W, T, m as me, O } from "./cimAnalyzer.js";
...
class z {
  ...
  getSymbolImage(e) {
    ...
    for (let a = 0; a < e.length; a++) {
      ...
      let y = t3.angle, w = u(g2) - m3[0] * (0.5 + f2), C = u(u$1) - m3[1] * (0.5 + d), M2 = w + m3[0], _2 = C + m3[1];
      if (y) {
        p2 && (y = -y);
        const e2 = Math.sin(y * Math.PI / 180), t4 = Math.cos(y * Math.PI / 180), a2 = w * t4 - C * e2, i2 = w * e2 + C * t4, r2 = w * t4 - _2 * e2, s3 = w * e2 + _2 * t4, o3 = M2 * t4 - _2 * e2, n2 = M2 * e2 + _2 * t4, c3 = M2 * t4 - C * e2, h2 = M2 * e2 + C * t4;
      ...
      const z2 = { offsetX: g2, offsetY: u$1, rotateClockwise: p2, angle: y, rasterizedImage: v2, anchorX: f2, anchorY: d };
      h.push(z2);
    }
  ...
  _getRasterizedResource(e, t$1, i, r2, s2, o2) {
    ...
    return f2.has(c2) ? f2.get(c2) : (h = this._rasterizer.rasterizeJSONResource({ cim: u2, type: e.type, url: e.url, mosaicHash: c2, size: l2, path: m$1 }, window.devicePixelRatio || 1, this._avoidSDF), f2.set(c2, h), h);
  }
