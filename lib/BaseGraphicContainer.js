...
import { C as r$3, j6 as R, eh as u$1, Z as v$1, A as e$7, j7 as c$2, j8 as et, gl as t$7, j9 as y$4, a2 as t$8, ja as r$4, jb as O, jc as q, jd as U$1, je as C, jf as ht, jg as at, jh as $, ji as i$2, jj as U$2, jk as E$1, jl as e$8, jm as c$3, fK as u$2, cc as s$3, N as e$9, O as y$5, P as n$3, dc as has, a7 as a$2, al as m$1, jn as l$2, ad as l$4, bm as f$4, jo as s$4, jp as l$5, gp as j, r as k, gU as w$1, jq as f$5, jr as u$3, js as f$6, jt as g$5, iE as g$6, ju as s$5, jv as l$6, jw as O$1, jx as j$1, jy as N, hY as e$a, jz as r$7, i0 as i$3, iU as M, gu as t$9, iS as f$7, iT as h$2 } from "./index.js";
import { a as ae$1, V, Q, n as n$5 } from "./cimAnalyzer.js";
import { p as p$2 } from "./normalizeUtilsSync.js";
import { U as U$3 } from "./definitions.js";
...
const y$1 = new t$7(), g$2 = new t$7(), f$1 = "esriGeometryPolyline";
function d(t2) {
...
let re = class extends t$1(a$2(m$1)) {
  ...
  _getArcadeInfo(e2) {
    ...
    return t$8(e2.geometry) ? null : { geometryType: c$2(e2.geometry), spatialReference: k.fromJSON(e2.geometry.spatialReference), fields: t2 };
  }
  ...
  async _getSymbolResources(e2, t2) {
    ...
    return this.container.stage ? this._getSymbolForGraphic(e2, t2).then((i2) => {
      const r2 = i2.hash();
      return this._getCIMSymbol(i2, r2, t2).then((i3) => t$8(i3) ? null : this._expandCIMSymbol(i3, e2, r2, t2).then((e3) => {
  ...
  async _projectAndNormalizeGeometry(e2, t2) {
    if (f$4(this._controller.signal), t$8(e2.geometry) || e2.geometry.type === "mesh")
      return null;
    let s2 = e2.geometry;
    if (y$4(s2)) {
      const e3 = s2.rings;
