...
import { a as e$4 } from "./vec33.js";
import { s as s$1, r as r$4, c as c$3, e as e$5 } from "./types.js";
import { eF as X, aX as f$4, hI as Y$1, x as t$5, fo as U, gi as b, gj as w, ew as s$2, dH as s$3, c5 as n$4, hJ as p$1, b9 as e$6, hs as r$5, gg as nt, hK as r$6, ce as u$2, dC as r$7, b8 as c$5, f9 as x$2, db as f$5, bC as i$3, hL as Q, hM as L$2, eP as e$7, r as r$8, fq as i$4, eH as e$8 } from "./index.js";
import { D, L, C, E as E$2 } from "./enums.js";
import { B, g, d as d$2, i as i$2, c as c$4, u as u$1, x as x$1, L as L$1, O, E as E$1, F as F$1, w as w$1, q as q$1, A as A$1, V as V$1 } from "./BufferView.js";
import { u as u$3, t as t$6 } from "./Indices.js";
function t$4(t2, r2, f2) {
  if (t2.count !== r2.count)
    return void e$4.error("source and destination buffers need to have the same number of elements");
...
Object.freeze(Object.defineProperty({ __proto__: null, transformMat4: t$4, transformMat3: r$3, normalize: f$3, scale: o$3, shiftRight: n$3 }, Symbol.toStringTag, { value: "Module" }));
...
Object.freeze(Object.defineProperty({ __proto__: null, copy: e$2 }, Symbol.toStringTag, { value: "Module" }));
...
Object.freeze(Object.defineProperty({ __proto__: null, copy: e$1, makeDense: t$3 }, Symbol.toStringTag, { value: "Module" }));
...
Object.freeze(Object.defineProperty({ __proto__: null, copy: f$2, normalizeIntegerBuffer: n$2, fill: d$1 }, Symbol.toStringTag, { value: "Module" }));
function e(e2, t2, f2) {
...
function t$2(e2, t2, f2, d2, n2, o2) {
  var _a, _b;
...
Object.freeze(Object.defineProperty({ __proto__: null, copy: e, fill: t$2 }, Symbol.toStringTag, { value: "Module" }));
function r$2(s2, r2) {
  return new s2(new ArrayBuffer(r2 * s2.ElementCount * e$5(s2.ElementType)));
}
class n$1 {
  constructor(r2) {
  ...
  async loadBinary(r2, e2) {
    return X(r2) ? (f$4(e2), Y$1(r2)) : this._load("binary", r2, e2);
  }
  async loadImage(r2, e2) {
    return this._load("image", r2, e2);
  }
  async _load(t2, i2, m2) {
    if (t$5(this._streamDataRequester))
...
const t = { baseColorFactor: [1, 1, 1, 1], metallicFactor: 1, roughnessFactor: 1 }, a = { pbrMetallicRoughness: t, emissiveFactor: [0, 0, 0], alphaMode: "OPAQUE", alphaCutoff: 0.5, doubleSided: false }, l = { ESRI_externalColorMixMode: "tint" }, i$1 = (e2 = {}) => {
  const o2 = __spreadValues(__spreadValues({}, t), e2.pbrMetallicRoughness), r2 = s(__spreadValues(__spreadValues({}, l), e2.extras));
...
function s(o2) {
  switch (o2.ESRI_externalColorMixMode) {
    ...
    case "replace":
      break;
    default:
      n$4(o2.ESRI_externalColorMixMode), o2.ESRI_externalColorMixMode = "tint";
  }
  return o2;
}
const n = { magFilter: L.LINEAR, minFilter: L.LINEAR_MIPMAP_LINEAR, wrapS: D.REPEAT, wrapT: D.REPEAT }, c$1 = (e2) => __spreadValues(__spreadValues({}, n), e2);
function r(r2) {
  let e2, t2;
...
class F {
  constructor(e2, t2, r$12, s2, n2) {
    this._context = e2, this._errorContext = t2, this.uri = r$12, this.json = s2, this._glbBuffer = n2, this._bufferLoaders = new Map(), this._textureLoaders = new Map(), this._textureCache = new Map(), this._materialCache = new Map(), this._nodeParentMap = new Map(), this._nodeTransformCache = new Map(), this._baseUri = r(this.uri).dirPart, this._checkVersionSupported(), this._checkRequiredExtensionsSupported(), t2.errorUnsupportedIf(s2.scenes == null, "Scenes must be defined."), t2.errorUnsupportedIf(s2.meshes == null, "Meshes must be defined"), t2.errorUnsupportedIf(s2.nodes == null, "Nodes must be defined."), this._computeNodeParents();
  }
  ...
  async getIndexData(e2, t2) {
    ...
    if (r2.isDenselyPacked)
      ...
      switch (r2.componentType) {
        case C.UNSIGNED_BYTE:
          return t$3(this._wrapAccessor(d$2, r2));
        case C.UNSIGNED_SHORT:
          return t$3(this._wrapAccessor(g, r2));
        case C.UNSIGNED_INT:
          return t$3(this._wrapAccessor(B, r2));
      }
  }
  async getPositionData(e2, t2) {
    ...
    return r2.errorUnsupportedIf(s2.componentType !== C.FLOAT, "Expected type FLOAT for POSITION vertex attribute, but found " + C[s2.componentType]), r2.errorUnsupportedIf(s2.componentCount !== 3, "POSITION vertex attribute must have 3 components, but found " + s2.componentCount.toFixed()), this._wrapAccessor(i$2, s2);
  }
  async getNormalData(e2, t2) {
    ...
    return r2.errorUnsupportedIf(s2.componentType !== C.FLOAT, "Expected type FLOAT for NORMAL vertex attribute, but found " + C[s2.componentType]), r2.errorUnsupportedIf(s2.componentCount !== 3, "NORMAL vertex attribute must have 3 components, but found " + s2.componentCount.toFixed()), this._wrapAccessor(i$2, s2);
  }
  ...
  async getVertexColors(e2, t2) {
    ...
    if (r2.errorUnsupportedIf(s2.componentCount !== 4 && s2.componentCount !== 3, "COLOR_0 attribute must have 3 or 4 components, but found " + s2.componentCount.toFixed()), s2.componentCount === 4) {
      ...
      if (s2.componentType === C.FLOAT)
        return this._wrapAccessor(i$2, s2);
      if (s2.componentType === C.UNSIGNED_BYTE)
  ...
  async getMaterial(e2, t2, r2) {
    ...
    if (!s2) {
      const n2 = e2.material != null ? i$1(this.json.materials[e2.material]) : i$1(), o2 = n2.pbrMetallicRoughness, a2 = this.hasVertexColors(e2), i2 = this.getTexture(o2.baseColorTexture, t2), u2 = this.getTexture(n2.normalTexture, t2), c2 = r2 ? this.getTexture(n2.occlusionTexture, t2) : void 0, f2 = r2 ? this.getTexture(n2.emissiveTexture, t2) : void 0, d2 = r2 ? this.getTexture(o2.metallicRoughnessTexture, t2) : void 0, p2 = e2.material != null ? e2.material : -1;
  ...
  getNodeTransform(e2) {
    ...
    if (!t2) {
      ...
      s2.matrix ? t2 = u$2(e$6(), r2, s2.matrix) : s2.translation || s2.rotation || s2.scale ? (t2 = r$7(r2), s2.translation && c$5(t2, t2, s2.translation), s2.rotation && (H[3] = x$2(H, s2.rotation), f$5(t2, t2, H[3], H)), s2.scale && i$3(t2, t2, s2.scale)) : t2 = r2, this._nodeTransformCache.set(e2, t2);
    }
    return t2;
  }
  _wrapAccessor(e2, t2) {
  ...
  _checkVersionSupported() {
    const e2 = r$5.parse(this.json.asset.version, "glTF");
    P.validate(e2);
  }
...
const P = new r$5(2, 0, "glTF"), k = p$1(e$6(), Math.PI / 2), H = e$7(), V = { SCALAR: 1, VEC2: 2, VEC3: 3, VEC4: 4 }, Y = { [C.BYTE]: 1, [C.UNSIGNED_BYTE]: 1, [C.SHORT]: 2, [C.UNSIGNED_SHORT]: 2, [C.FLOAT]: 4, [C.UNSIGNED_INT]: 4 };
function J(e2) {
  switch (e2.componentType) {
    ...
    case C.FLOAT:
      return new u$1(e2.raw, e2.byteOffset, e2.byteStride, e2.byteOffset + e2.byteStride * e2.entryCount);
  }
}
async function K(e2) {
...
async function m(r2, s2, a2 = {}, i2 = true) {
  const m2 = await F.load(r2, x, s2, a2), p2 = "gltf_" + u++, T2 = { lods: [], materials: new Map(), textures: new Map(), meta: c(m2) }, h = !(!m2.json.asset.extras || m2.json.asset.extras.ESRI_type !== "symbolResource"), g2 = new Map();
...
function c(o2) {
  ...
  return t2.nodes.forEach((o3) => {
    const t3 = o3.extras;
    r$8(t3) && (t3.ESRI_proxyEllipsoid || t3.ESRI_lod) && (r2 = t3);
  }), r2;
}
...
const o = 2.1;
export { r$3 as a, n$2 as b, o$3 as c, o$1 as d, e, f, f$3 as g, d$1 as h, i, n$3 as j, m, n$1 as n, o, r$2 as r, t$2 as t };
