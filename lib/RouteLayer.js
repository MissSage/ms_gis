...
import { N as e, O as y$4, ni as j, P as n$4, dM as l$4, y as y$5, iu as m$3, iv as S, nj as r, ib as o, ia as r$1, a2 as t, ea as s$1, s as s$2, qf as i$2, U as U$2, qI as Ct, lZ as t$1, n5 as f$2, C as r$3, lh as s$3, qJ as a$2, I as w, J as g, W as m$4, fO as w$1, ll as x, r as k$1, A as e$1, nr as v$1, dJ as i$3, qg as i$4, l1 as v$2, ic as v$3, qK as t$2, k as j$1, pr as n$7, ps as t$3, mf as c$8, mg as v$4, mh as O$2, a7 as a$5, m as b$1, bn as a$6, lE as o$1, M as u$6, nS as c$9, hR as s$5, qv as S$2, v as j$2, x as x$1, l as j$3, qL as l$5, gp as j$4, qM as o$2, mR as k$2, ak as E, _ as _n, u as rn } from "./index.js";
import { i as i$6 } from "./originUtils.js";
import { f as f$5 } from "./portalItemUtils.js";
import { y as y$6, N, U as U$1, r as r$2, A, R as R$1, c as a$3, n as n$5, w as w$2, S as S$1, d as D$1, s as s$4, e as f$3, i as i$5, j as a$4, k as n$6, b, h, O as O$1, g as g$1, f as f$4, D as D$2, a as h$1, t as t$4, l as l$6 } from "./Stop.js";
import "vue";
...
e([y$4({ types: j })], p$5.prototype, "break", void 0), e([y$4({ types: j })], p$5.prototype, "first", void 0), e([y$4({ types: j })], p$5.prototype, "unlocated", void 0), e([y$4({ types: j })], p$5.prototype, "last", void 0), e([y$4({ types: j })], p$5.prototype, "middle", void 0), e([y$4({ types: j })], p$5.prototype, "waypoint", void 0), p$5 = e([n$4("esri.layers.support.RouteStopSymbols")], p$5);
const l$3 = p$5;
...
const u$5 = n$2;
let p$4 = class extends l$4 {
  constructor(t2) {
    super(t2), this.buildTime = null, this.name = null, this.networkAttributes = null, this.networkSources = null, this.state = null;
  }
};
e([y$4({ type: Number })], p$4.prototype, "buildTime", void 0), e([y$4({ type: String })], p$4.prototype, "name", void 0), e([y$4({ type: [u$5] })], p$4.prototype, "networkAttributes", void 0), e([y$4()], p$4.prototype, "networkSources", void 0), e([y$4({ type: String })], p$4.prototype, "state", void 0), p$4 = e([n$4("esri.rest.support.NetworkDataset")], p$4);
const i$1 = p$4;
...
async function p$3(t2, o2, s2) {
  if (!t2)
    throw new s$2("network-service:missing-url", "Url to Network service is missing");
  const a2 = i$2({ f: "json", token: o2 }, s2), { data: l2 } = await U$2(t2, a2);
...
async function v(r2, t2) {
  var _a, _b, _c;
  const o2 = i$2({ f: "json" }, t2), { data: i2 } = await U$2(r2.replace(/\/rest\/.*$/i, "/info"), o2);
  if (!i2 || !i2.owningSystemUrl)
    return { supportedTravelModes: [], defaultTravelMode: null };
  const { owningSystemUrl: d2 } = i2, u2 = Ct(d2) + "/sharing/rest/portals/self", { data: f2 } = await U$2(u2, o2), c2 = t$1("helperServices.routingUtilities.url", f2);
  if (!c2)
    return { supportedTravelModes: [], defaultTravelMode: null };
  const p2 = f$2(d2), v2 = /\/solve$/i.test(p2.path) ? "Route" : /\/solveclosestfacility$/i.test(p2.path) ? "ClosestFacility" : "ServiceAreas", m2 = i$2({ f: "json", serviceName: v2 }, t2), T = Ct(c2) + "/GetTravelModes/execute", M = await U$2(T, m2), h2 = [];
  let g2 = null;
...
async function m$2(t2, o2, s2) {
  try {
    const r2 = i$2({ f: "json", token: o2 }, s2), l2 = Ct(t2) + "/retrieveTravelModes", { data: { supportedTravelModes: i2, defaultTravelMode: d2 } } = await U$2(l2, r2);
...
function m$1(r2) {
  ...
  for (; d2 < u2.length && u2[d2] !== "|"; ) {
    c2 = parseInt(u2[d2], 32) + e2, d2++, e2 = c2, i2 = parseInt(u2[d2], 32) + t$12, d2++, t$12 = i2;
...
function y(e2) {
  ...
  const v2 = ((_a = l2 == null ? void 0 : l2.features.every((e3) => t(e3.attributes.RouteName))) != null ? _a : false) && R2.length > 0 ? R2[0].routeName : null;
...
e([y$4({ type: Boolean, json: { write: true } })], l.prototype, "doNotLocateOnRestrictedElements", void 0), e([y$4({ types: i$4, json: { read: v$2, write: true } })], l.prototype, "geometry", void 0), e([r(w$2)], l.prototype, "geometryType", void 0), e([y$4({ type: String, json: { name: "layerName", write: true } })], l.prototype, "name", void 0), e([r(S$1, { name: "spatialRel" })], l.prototype, "spatialRelationship", void 0), e([y$4({ type: String, json: { write: true } })], l.prototype, "type", void 0), e([y$4({ type: String, json: { write: true } })], l.prototype, "where", void 0), l = e([n$4("esri.rest.support.DataLayer")], l);
const c$2 = l;
var s;
...
let k = O = class extends i$3(l$4) {
  ...
  writeAccumulateAttributes(t$12, e2, r2) {
    !t(t$12) && t$12.length && (e2[r2] = t$12.map((t2) => y$6.toJSON(t2)));
  }
  ...
  readRestrictionAttributes(t$12) {
    return t(t$12) ? null : t$12.map((t2) => D$1.fromJSON(t2));
  }
  writeRestrictionAttributes(t$12, e2, r2) {
    !t(t$12) && t$12.length && (e2[r2] = t$12.map((t2) => D$1.toJSON(t2)));
  }
  readStartTime(t$12, e2) {
    const { startTime: r2 } = e2;
    return t(r2) ? null : r2 === "now" ? "now" : new Date(r2);
  }
  writeStartTime(t$12, e2) {
    t(t$12) || (e2.startTime = t$12 === "now" ? "now" : t$12.getTime());
  }
  readStops(t2, e2) {
    return C(e2.stops);
  }
...
function se(e2, t$12, r2) {
  var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n2, _o, _p, _q, _r, _s, _t, _u, _v;
  const o2 = (_a = t$12.networkDataset) == null ? void 0 : _a.networkAttributes, i2 = (_b = o2 == null ? void 0 : o2.filter((e3) => e3.usageType === "cost")) != null ? _b : [], s2 = ee(t$12), a2 = (_c = r2.travelMode) != null ? _c : s2;
  if (t(a2))
  ...
  const { timeAttributeName: l2, distanceAttributeName: c2 } = a2, y2 = i2.find((e3) => e3.name === l2), f2 = i2.find((e3) => e3.name === c2), d2 = (_f = (_e = (_d = e$1(r2.travelMode)) == null ? void 0 : _d.impedanceAttributeName) != null ? _e : e$1(r2.impedanceAttribute)) != null ? _f : t$12.impedance, h2 = t$4.fromJSON(y2 == null ? void 0 : y2.units), w2 = r$2.fromJSON(f2 == null ? void 0 : f2.units);
  if (!h2 || !w2)
    throw new s$2("routelayer:unknown-impedance-units", "the units of either the distance or time impedance are unknown");
  const S2 = (_g = r2.directionsLanguage) != null ? _g : t$12.directionsLanguage, g2 = (_i = (_h = e$1(r2.accumulateAttributes)) != null ? _h : t$12.accumulateAttributeNames) != null ? _i : [], b2 = new Set(i2.filter(({ name: e3 }) => e3 === l2 || e3 === c2 || e3 === d2 || e3 != null && g2.includes(e3)).map(({ name: e3 }) => e3)), v2 = (e3) => {
    for (const t2 in e3)
      b2.has(t2) || delete e3[t2];
  };
...
let Se = class extends n$7(t$3(c$8(v$4(O$2(a$5(b$1)))))) {
  ...
  get fullExtent() {
    ...
    if (t(this.stops))
      return e2;
    const t$12 = this.stops.filter((e3) => r$3(e3.geometry));
    if (t$12.length < 2)
      return e2;
    const { spatialReference: r2 } = t$12.getItemAt(0).geometry;
    if (t(r2))
      return e2;
    const o2 = t$12.toArray().map((e3) => {
  ...
  async save() {
    await this.load();
    const { fullExtent: e2, portalItem: t$12 } = this;
    if (!t$12)
    ...
    if (t$12.type !== "Feature Collection")
    ...
    const { portal: r2 } = t$12;
    await r2._signIn(), r2.user || await t$12.reload();
    const { itemUrl: o2, itemControl: i2 } = t$12;
    ...
    return t$12.extent = await ne(e2), t$12.title = this.title, await t$12.update({ data: a2 }), t$12;
  }
  async saveAs(e2, t$12 = {}) {
    var _a, _b, _c;
    ...
    await o2._signIn();
    const s2 = t$12 == null ? void 0 : t$12.folder, a2 = this.write(null, i2);
    return await o2.user.addItem({ item: r2, folder: s2, data: a2 }), this.portalItem = r2, i$6(i2), i2.portalItem = r2, r2;
  }
  async solve(e2, t$12) {
    var _a, _b, _c, _d, _e;
    ...
    if (j$1.isCollection(r2))
      for (const s2 of r2)
        s2.routeName = null;
    const l2 = e2 == null ? void 0 : e2.apiKey, m$12 = this.url, y2 = await this._getServiceDescription(m$12, l2, t$12), f2 = ee(y2), h2 = (_e = e2 == null ? void 0 : e2.travelMode) != null ? _e : f2, w2 = l$5(e2 == null ? void 0 : e2.accumulateAttributes, []);
  ...
  _getNetworkFeatures(e2, t$12, n2, a2) {
    var _a, _b, _c;
    const l2 = (re(e2) ? e2.layers : e2.featureCollection.layers).find((e3) => e3.layerDefinition.name === t$12);
    if (t(l2))
      return new j$1();
    const { layerDefinition: m2, popupInfo: c2, featureSet: y2 } = l2, f2 = m2.drawingInfo.renderer, { features: d2 } = y2, h2 = (_c = (_b = (_a = y2.spatialReference) != null ? _a : m2.spatialReference) != null ? _b : m2.extent.spatialReference) != null ? _c : c$9, w2 = f2 && o$2(f2), S2 = k$1.fromJSON(h2), g$12 = d2.map((e3) => {
      ...
      r$3(i2.geometry) && r$3(e3.geometry) && t(e3.geometry.spatialReference) && (i2.geometry.spatialReference = S2);
      const s2 = n2(i2);
      return (_b2 = s2.symbol) != null ? _b2 : s2.symbol = (_a2 = w2 == null ? void 0 : w2.getSymbol(i2)) != null ? _a2 : this._getNetworkSymbol(t$12), (_c2 = s2.popupTemplate) != null ? _c2 : s2.popupTemplate = c2 && k$2.fromJSON(c2), s2;
    });
  ...
  _setStopSymbol(e2) {
    ...
    if (e2.every((e3) => r$3(e3.symbol)))
      return;
    const { first: t$12, last: r2, middle: o2, unlocated: i2, waypoint: s2, break: n2 } = this.defaultSymbols.stops;
    if (t(this.routeInfo) || e2.length === 1)
    ...
    for (const p2 of e2)
      p2.sequence !== l2 ? p2.sequence !== m2 ? p2.status === "ok" || p2.status === "not-located-on-closest" ? p2.locationType !== "waypoint" ? p2.locationType !== "break" ? p2.symbol = o2 : p2.symbol = n2 : p2.symbol = s2 : p2.symbol = i2 : p2.symbol = r2 : p2.symbol = t$12;
  }
  ...
  _writeNetworkFeatures(e2, t$12, r2, o2, i2, s2, n2) {
    if (t(e2) || !e2.length)
      return null;
    const a2 = this.spatialReference.toJSON(), { fullExtent: l2, maxScale: m2, minScale: c2 } = this;
    return { featureSet: { features: e2.toArray().map((e3) => pe(e3)), geometryType: r2, spatialReference: a2 }, layerDefinition: { capabilities: "Query,Update,Editing", drawingInfo: { renderer: { type: "simple", symbol: r$3(t$12) ? t$12.toJSON() : te(r2) } }, extent: l2.toJSON(), fields: o2, geometryType: r2, hasM: false, hasZ: false, maxScale: m2, minScale: c2, name: s2, objectIdField: "ObjectID", spatialReference: a2, title: n2, type: "Feature Layer", typeIdField: "" }, popupInfo: i2 };
  }
  _writePointBarriers() {
  ...
  _writeStops() {
    ...
    if (t(e2))
      return null;
    const { stops: t$12 } = this.defaultSymbols, r2 = r$3(t$12) && r$3(t$12.first) && t$12.first.toJSON(), o2 = r$3(t$12) && r$3(t$12.middle) && t$12.middle.toJSON(), i2 = r$3(t$12) && r$3(t$12.last) && t$12.last.toJSON();
