import { dc as has, hh as D, a8 as n$1, C as r, hn as G, ea as s, s as s$1, a2 as t$1, nT as gt, eh as u$1 } from "./index.js";
import { h } from "./PooledRBush.js";
import { i } from "./optimizedFeatureQueryEngineAdapter.js";
...
class u {
  ...
  _add(t2) {
    ...
    if (i2 == null)
      return void s.getLogger("esri.layers.graphics.data.FeatureStore").error(new s$1("featurestore:invalid-feature", "feature id is missing", { feature: t2 }));
