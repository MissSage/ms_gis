...
import { bj as l$7, X as y$3, j9 as y$4, jq as f$6, jv as l$8, ju as s$6, jr as u$7, jH as O$1, jI as P$2, jJ as R$1, jK as k$1, jL as B$2, eh as u$8, jm as c$7, jM as A$1, jN as X, jO as o$5, jP as Y$3, jQ as t$5, jR as Z$3, jS as M$2, jT as s$7, jU as u$9, jV as i$5, jW as G$2, eg as o$6, A as e$8, jX as s$8, jY as K$3, dc as has, jZ as g$5, fK as u$a, gu as t$6, eC as n$c, j_ as h$5, j$ as n$d, k0 as o$7, br as r$f, k1 as z$1, k2 as i$6, k3 as e$9, k4 as a$b, ea as s$9, k5 as o$8, C as r$g, k6 as I$1, k7 as h$6, a2 as t$9, k8 as A$2, gX as e$a, k9 as U$3, ka as w$3, kb as g$6, kc as S, kd as w$4, ke as x$3, kf as k$2, kg as P$3, e2 as e$c, ja as r$h, kh as C$3, ki as l$9, kj as a$d, kk as u$b, kl as y$5, km as b$3, kn as ne$2, ko as oe$2, kp as m$4, kq as ie$2, kr as m$5, ks as d$2, kt as p$3, hi as m$6, ku as F$1, gV as o$9, kv as i$8, kw as l$a, kx as c$8, ky as i$9, kz as u$c, kA as t$a, kB as L$1, kC as s$a, kD as c$9, kE as p$4, jE as e$d, jF as n$f } from "./index.js";
import { a as a$c } from "./fontUtils.js";
import { C as C$2 } from "./BidiEngine.js";
import { t as t$8, e as e$b } from "./alignmentUtils.js";
import { j as j$4, f as f$7, d as dt } from "./definitions.js";
import { w as w$2 } from "./number.js";
import { t as t$7 } from "./Rect.js";
import { i as i$7 } from "./callExpressionWithFeature.js";
import { n as n$e } from "./GeometryUtils.js";
import { o as o$a } from "./floatRGBA.js";
const i$4 = new C$2();
function n$b(r2) {
  if (!i$4.hasBidiChar(r2))
    return [r2, false];
  let n2;
  return n2 = i$4.checkContextual(r2) === "rtl" ? "IDNNN" : "ICNNN", [i$4.bidiTransform(r2, n2, "VLYSN"), true];
}
class t$4 {
  constructor() {
    this.setIdentity();
...
class a$a {
  ...
  tintImageData(a2, e2) {
    ...
    const s2 = i2.getImageData(0, 0, n2, o2), l2 = new Uint8Array(s2.data), g2 = new l$7(e2), h2 = [g2.r / 255, g2.g / 255, g2.b / 255, g2.a];
...
function l$6(t2) {
  t2 && (s$6(t2) ? t2.y = -t2.y : y$4(t2) ? u$6(t2.rings) : f$6(t2) ? u$6(t2.paths) : l$8(t2) && r$d(t2.points));
}
function r$d(t2) {
  if (t2) {
    const i2 = t2.length;
...
function P$1(t2) {
  t2 && (y$4(t2) ? m$3(t2.rings) : f$6(t2) ? m$3(t2.paths) : l$8(t2) && p$2(t2.points), l$6(t2));
}
function x$2(t2) {
  t2 && (l$6(t2), y$4(t2) ? f$5(t2.rings) : f$6(t2) ? f$5(t2.paths) : l$8(t2) && c$6(t2.points));
}
function g$4(t2) {
  if (t2)
    for (const i2 of t2)
...
class G$1 {
  constructor(t2, s2, e2, a2 = 0) {
    this.isClosed = false, this.multiPath = null, this.acceptPolygon = s2, this.acceptPolyline = e2, this.geomUnitsPerPoint = a2, this.pathCount = -1, this.pathIndex = -1, this.iteratePath = false, t2 && (y$4(t2) ? s2 && (this.multiPath = t2.rings, this.isClosed = true) : f$6(t2) ? e2 && (this.multiPath = t2.paths, this.isClosed = false) : u$7(t2) && s2 && (this.multiPath = b$2(t2).rings, this.isClosed = true), this.multiPath && (this.pathCount = this.multiPath.length)), this.internalPlacement = new t$4();
  }
  next() {
    if (!this.multiPath)
      return null;
  ...
  next() {
    for (; ; ) {
      if (!this.multiPath) {
        ...
        for (; t2; ) {
          if (y$4(t2) ? this.acceptPolygon && (this.multiPath = t2.rings, this.isClosed = true) : f$6(t2) ? this.acceptPolyline && (this.multiPath = t2.paths, this.isClosed = false) : u$7(t2) && this.acceptPolygon && (this.multiPath = b$2(t2).rings, this.isClosed = true), this.multiPath) {
...
const l$5 = 1.7320508075688772, c$5 = 5, u$5 = P$2.OpenEnded;
class h$4 {
  static local() {
...
class a$8 extends U$2 {
  constructor(t2, e2, o2) {
    super(t2, false, true), this._curveHelper = new n$a(), this._width = (e2.width !== void 0 ? e2.width : c$5) * o2, this._arrowType = e2.geometricEffectArrowType !== void 0 ? e2.geometricEffectArrowType : e2.arrowType !== void 0 ? e2.arrowType : u$5, this._offsetFlattenError = e$7 * o2;
  }
  processPath(t2) {
  ...
  _constructCrossedArrow(t2) {
    ...
    let r2 = this._width;
    e2 < r2 * (1 + l$5 + 1) && (r2 = e2 / (1 + l$5 + 1));
    const n2 = this._curveHelper.getSubCurve(t2, 0, e2 - r2 * (1 + l$5));
    if (!n2)
      return null;
    const s2 = r2 / 2;
...
class h$3 {
  ...
  next() {
    ...
    for (; n2; ) {
      ...
      s$6(n2) && this._size, n2 = this._inputGeometries.next();
    }
    return null;
  }
}
...
class c$4 {
  ...
  next() {
    ...
    for (; e2 = this._inputGeometries.next(); ) {
      let r2;
      if (s$6(e2) ? r2 = this._processGeom([[[e2.x, e2.y]]]) : l$8(e2) ? r2 = this._processGeom([e2.points]) : f$6(e2) ? r2 = this._processGeom(e2.paths) : y$4(e2) && (r2 = this._processGeom(e2.rings)), r2 && r2.length)
        return { paths: r2 };
    }
    return null;
  }
...
class u$4 {
  ...
  execute(e2, t2, u2, i2) {
    return new s$4(e2, t2, u2);
  }
}
u$4.instance = null;
class s$4 extends U$2 {
...
class s$2 {
  static local() {
    return s$2.instance === null && (s$2.instance = new s$2()), s$2.instance;
  }
  execute(e2, t2, r2, s2) {
...
class c$2 {
  static local() {
    return c$2.instance === null && (c$2.instance = new c$2()), c$2.instance;
  }
  execute(t2, s2, i2, r2) {
    return new l$4(t2, s2, i2);
  }
}
c$2.instance = null;
class l$4 {
...
class o$3 {
  ...
  _constructCurve(t2, e2) {
    const s2 = new s$5(), h2 = this._walker.calculatePathLength(t2);
  ...
  _constructSquare(t2) {
    const e2 = new s$5(), s2 = this._walker.calculatePathLength(t2);
  ...
  constructor(e2, n2, _2, r2) {
    ...
    if (this._xMin = 0, this._xMax = 0, this._yMin = 0, this._yMax = 0, this._currentX = 0, this._currentY = 0, this._stepX = Math.abs((_a = n2.stepX) != null ? _a : 16) * _2, this._stepY = Math.abs((_b = n2.stepY) != null ? _b : 16) * _2, this._stepX !== 0 && this._stepY !== 0 && e2 && h$1(e2) && e2.rings) {
      if (this._gridType = (_c = n2.gridType) != null ? _c : Y$3.Fixed, this._gridType === Y$3.Random) {
        ...
        this._randomLCG = new t$5(s2 * i2), this._randomness = ((_e = n2.randomness) != null ? _e : 100) / 100, this._gridAngle = 0, this._shiftOddRows = false, this._cosAngle = 1, this._sinAngle = 0, this._offsetX = 0, this._offsetY = 0;
      } else {
...
class l$3 {
  static local() {
    return l$3.instance === null && (l$3.instance = new l$3()), l$3.instance;
  }
  execute(e2, t2, n2, i2) {
...
function u$2(t2) {
  ...
  if (Math.abs(f2) <= 2 * c2 * c2) {
    const t3 = s$7(u$8(), n2[l2]);
    return [(t3[0] + t3[2]) / 2, (t3[1] + t3[3]) / 2];
  }
  const u2 = u$9(n2[l2], false, u$8());
  if (u2 === null)
    return null;
  if (n2.length === 1 && n2[0].length < 4)
    return u2;
  const d2 = [[NaN, NaN], [NaN, NaN], [NaN, NaN], [NaN, NaN]], x2 = [NaN, NaN, NaN, NaN], M2 = [NaN, NaN, NaN, NaN];
  let b2 = false, w2 = m$1(u2, t2, true);
  w2.distance === 0 && (b2 = true, d2[0][0] = u2[0], d2[0][1] = u2[1], w2 = m$1(u2, t2, false)), x2[0] = w2.distance, M2[0] = 0;
  const y2 = [NaN, NaN];
  let C2 = false, k2 = 0.25, P2 = -1;
  const T2 = s$7(u$8(), n2[l2]);
  let z2 = NaN;
  do {
    if (z2 = NaN, d2[1] = g$2(t2, p$1(T2[0], T2[2], k2), c2, s2), isNaN(d2[1][0]) || isNaN(d2[1][1]) || (w2 = m$1(d2[1], t2, false), z2 = w2.distance), !isNaN(z2) && z2 > c2 && h(d2[1], t2))
  ...
  let D2 = 0.01, S2 = 1;
  do {
    if (z2 = NaN, d2[2] = g$2(t2, p$1(T2[0], T2[2], k2), c2, s2), isNaN(d2[2][0]) || isNaN(d2[2][1]) || (w2 = m$1(d2[2], t2, false), z2 = w2.distance), !isNaN(z2) && z2 > c2 && h(d2[2], t2))
  ...
  do {
    if (z2 = NaN, d2[3] = g$2(t2, p$1(T2[0], T2[2], k2), c2, s2), isNaN(d2[3][0]) || isNaN(d2[3][1]) || (w2 = m$1(d2[3], t2, false), z2 = w2.distance), !isNaN(z2) && z2 > c2 && h(d2[3], t2))
...
function g$2(t2, n2, i2, r2) {
  ...
  const N2 = [[n2, r2[1] - 1], [n2, r2[3] + 1]], u2 = [0, 0], h2 = [0, 0], m2 = [0, 0], g2 = [[0, 0], [0, 0]], x2 = u$8(), { rings: M2 } = t2;
  for (const e2 of M2)
    if (!(e2.length < 2))
...
class k {
  constructor(t2, n2, e2, i2) {
    this.x = t2, this.y = n2, this.cellSize = e2, this.distancefromCellCenter = s$8(t2, n2, i2), this.maxDistanceToPolygon = this.distancefromCellCenter + this.cellSize * Math.SQRT2;
  }
}
const P = 1, T$2 = 100;
function z(i2) {
...
class f$2 {
  ...
  next() {
    const t2 = this._geometry;
    return this._geometry = null, t2 && l$2(t2) ? this._polygonCenter(t2) : null;
  }
  _polygonCenter(r2) {
    let l2 = false;
    switch (this._method) {
      ...
      case K$3.BoundingBoxCenter:
        {
          const s2 = u$8();
          c$7(s2, r2), s2 && (this._internalPlacement.setTranslate((s2[2] + s2[0]) / 2 + this._offsetX, (s2[3] + s2[1]) / 2 + this._offsetY), l2 = true);
        }
        break;
      case K$3.OnPolygon:
      default: {
        let t2;
        t2 = has("polylabel-placement-enabled") ? z(r2) : u$2(r2), t2 !== null && (this._internalPlacement.setTranslate(t2[0] + this._offsetX, t2[1] + this._offsetY), l2 = true);
      }
    }
...
class s$1 {
  ...
  rasterizeText(t2, s2) {
    ...
    this._fillStyle = i$2(c2), this._haloStyle = e$3(_2);
  ...
  _setFontProperties(e2, i2) {
    const s2 = Math.max(i2.size, 0.5), n2 = i2.font, r2 = `${n2.style} ${n2.weight} ${u$a(s2 * i2.pixelRatio).toFixed(1)}px ${n2.family}, sans-serif`;
    let o2;
...
class i$1 {
  constructor(i2, e2, s2, r2) {
    this.center = t$6(i2, e2), this.centerT = n$c(), this.halfWidth = s2 / 2, this.halfHeight = r2 / 2, this.width = s2, this.height = r2;
  }
  get x() {
  ...
  clone() {
    return new i$1(this.x, this.y, this.width, this.height);
  }
  serialize(t2) {
  ...
  static deserialize(t2) {
    ...
    return new i$1(h2, e2, s2, r2);
  }
}
const l$1 = 26, u$1 = 4, g = l$1 + u$1, _$1 = l$1 - 6, p = 3, x = 8, w = Math.PI / 180;
class y {
  constructor(t2, s2, e2, i2) {
    this._rotationT = n$d(), this._xBounds = 0, this._yBounds = 0, this.minZoom = 0, this.maxZoom = 255, this._bounds = null;
  ...
  set angle(s2) {
    this._angle = s2, h$5(this._rotationT, -s2), this._setOffsets(this._data);
  }
  get angle() {
    return this._angle;
  }
  ...
  get bounds() {
    if (!this._bounds) {
      ...
      const a2 = o$7(n$d(), this._rotationT, this._transform);
      a$b(r2, r2, a2);
      ...
      this._bounds = new i$1(_2, p2, u2, g2);
    }
    return this._bounds;
  }
  setTransform(t2) {
  ...
  _setOffsets(t2) {
    ...
    const e2 = this._offsets, i2 = new Float32Array(8), h2 = o$7(n$d(), this._rotationT, this._transform);
    a$b(i2, t2, h2), e2.upperLeft = w$2(i2[0] * x, i2[1] * x), e2.upperRight = w$2(i2[2] * x, i2[3] * x), e2.lowerLeft = w$2(i2[4] * x, i2[5] * x), e2.lowerRight = w$2(i2[6] * x, i2[7] * x);
  }
  _setTextureCoords({ x: t2, y: s2, width: e2, height: i2 }) {
    this._texcoords = { upperLeft: w$2(t2, s2), upperRight: w$2(t2 + e2, s2), lowerLeft: w$2(t2, s2 + i2), lowerRight: w$2(t2 + e2, s2 + i2) };
  }
}
const M = (t2, s2) => ({ code: 0, page: 0, sdf: true, rect: new t$7(0, 0, 11, 8), textureBinding: s2, metrics: { advance: 0, height: 4, width: t2, left: 0, top: 0 } });
class T$1 {
  constructor(t2, s2, e2) {
  ...
  setRotation(e2) {
    if (e2 === 0 && this._rotation === 0)
      return;
    this._rotation = e2;
    const i2 = this._transform, o2 = h$5(n$d(), e2);
    o$7(i2, o2, i2);
  ...
  get boundsT() {
    const t2 = this.bounds, s2 = r$f(n$c(), t2.x, t2.y);
    if (z$1(s2, s2, this._transform), this._hasRotation) {
      const e2 = Math.max(t2.width, t2.height);
      return new i$1(s2[0], s2[1], e2, e2);
    }
    return new i$1(s2[0], s2[1], t2.width, t2.height);
  }
  _createBounds(t2) {
    ...
    return new i$1(s2 + o2 / 2, e2 + h2 / 2, o2, h2);
  }
  _createGlyphTransform(t2, s2) {
    const o2 = w * s2.angle, r2 = n$d(), c2 = n$c();
    return i$6(r2, r2, r$f(c2, s2.xOffset, -s2.yOffset)), s2.isCIM ? e$9(r2, r2, o2) : (i$6(r2, r2, r$f(c2, t2.x, t2.y)), e$9(r2, r2, o2), i$6(r2, r2, r$f(c2, -t2.x, -t2.y))), r2;
  }
}
class B$1 {
...
function v(t2, s2) {
  ...
  const i2 = s2.decoration === "underline" ? u$1 : 0, n2 = t2[0].yMin;
  return { x: 0, y: n2, height: t2[t2.length - 1].yMax + s2.lineHeight * (t2.length - 1) + i2 - n2, width: e2 };
}
function j$1(t2, s2, e2) {
  const i2 = e2.scale, n2 = new Array(), o2 = L(t2, s2, e2), h2 = v(o2, e2), { vAlign: r2, hAlign: a2 } = e2, f2 = r2 === t$8.Baseline ? 1 : 0, d2 = f2 ? 0 : r2 - 1, m2 = (1 - f2) * -h2.y + d2 * (h2.height / 2) + (f2 ? 1 : 0) * -l$1;
...
const E$1 = Math.PI / 180, J$2 = 10, N = s$9.getLogger("esri.symbols.cim.CIMSymbolDrawHelper");
class O {
  constructor(t2) {
    this._t = t2;
  }
...
class Y$2 {
  constructor(t2, e2) {
    this._resourceManager = t2, this._transfos = [], this._sizeTransfos = [], this._geomUnitsPerPoint = 1, this._placementPool = new e$c(t$4, void 0, void 0, 100), this._earlyReturn = false, this._mapRotation = 0, this._transfos.push(e2 || O.createIdentity()), this._sizeTransfos.push(e2 ? e2.scaleRatio() : 1);
  }
  setTransform(t2, e2) {
  ...
  _buildHatchPolyline(t2, e2, r2) {
    ...
    for (; o2 < -n2; )
      o2 += i2;
    const a2 = u$8();
    c$7(a2, e2), a2[0] -= n2, a2[1] -= n2, a2[2] += n2, a2[3] += n2;
...
class q$2 extends Y$2 {
  ...
  bounds() {
    return o$8(this._xmin, this._ymin, this._xmax, this._ymax);
  }
  drawSolidFill(t2) {
  ...
  drawText(t2, e2) {
    if (!e2 || e2.length === 0)
      return;
    this._textRasterizer || (this._textRasterizer = new s$1());
...
class W$2 extends Y$2 {
  ...
  drawImage(t2, e2) {
    ...
    const c2 = A$2(i2) || "src" in a2 && A$2(a2.src);
  ...
  drawText(t2, e2) {
    ...
    this._textRasterizer || (this._textRasterizer = new s$1());
    const r2 = et(t2);
    r2.size *= this.transformSize(e$a(1));
  ...
  drawPictureFill(t2, e2) {
    ...
    const f2 = this._ctx, u2 = A$2(c2) || "src" in m2 && A$2(m2.src);
  ...
  drawPictureStroke(t2, e2) {
    ...
    m2 || (m2 = f2.width);
    const y2 = A$2(c2) || "src" in f2 && A$2(f2.src);
    ...
    const w2 = Math.max(this.transformSize(u$a(m2)), 0.5), x2 = w2 / P2.width, S2 = this._ctx, M2 = S2.createPattern(P2, "repeat-y");
    let b2, C2;
...
const Q$2 = (t2) => t2 ? { spatialReference: t2.spatialReference, rings: [[[t2.xmin, t2.ymin], [t2.xmin, t2.ymax], [t2.xmax, t2.ymax], [t2.xmax, t2.ymin], [t2.xmin, t2.ymin]]] } : null, Z$2 = (t2) => {
  switch (t2) {
    ...
    case "Center":
      return e$b.Center;
    case "Justify":
      return N.warnOnce("Horizontal alignment 'justify' is not implemented. Falling back to 'center'."), e$b.Center;
  }
}, $$2 = (t2) => {
  switch (t2) {
    case "Top":
...
function et(t2, r2 = 1) {
  const i2 = g$6(t2), s2 = S(t2.fontStyleName), o2 = a$c(t2.fontFamilyName), { weight: n2, style: a2 } = s2, l2 = r2 * (t2.height || 5), h2 = w$4(t2.horizontalAlignment), c2 = x$3(t2.verticalAlignment), m2 = k$2(t2), f2 = P$3(t2.haloSymbol), u2 = f2 ? r2 * (0 | t2.haloSize) : 0;
  return { color: m2, size: l2, horizontalAlignment: h2, verticalAlignment: c2, font: { family: o2, style: I$1(a2), weight: h$6(n2), decoration: i2 }, halo: { size: u2 || 0, color: f2, style: a2 }, pixelRatio: 1, premultiplyColors: true };
}
const rt = 1e-4;
function it(t2) {
...
const Y$1 = Math.PI, $$1 = Y$1 / 2, U$1 = 4, q$1 = 10, W$1 = 96 / 72, J$1 = Math.PI / 180, K$1 = s$9.getLogger("esri.symbols.cim.CIMSymbolHelper");
function Q$1(e2) {
  if (!e2 || !e2.type)
    return null;
  let t2;
...
class ae$1 {
  ...
  _vectorMarkerBounds(e2, t2, r2, a2) {
    ...
    if (t2 && t2.markerGraphics)
      for (const s2 of t2.markerGraphics) {
        const t3 = [0, 0, 0, 0];
        s2.geometry && (c$7(i2, s2.geometry), t3[0] = 0, t3[1] = 0, t3[2] = 0, t3[3] = 0, this.getSymbolInflateSize(t3, s2.symbol, r2, 0, a2), i2[0] += t3[0], i2[1] += t3[1], i2[2] += t3[2], i2[3] += t3[3], o2 ? (e2[0] = i2[0], e2[1] = i2[1], e2[2] = i2[2], e2[3] = i2[3], o2 = false) : (e2[0] = Math.min(e2[0], i2[0]), e2[1] = Math.min(e2[1], i2[1]), e2[2] = Math.max(e2[2], i2[2]), e2[3] = Math.max(e2[3], i2[3])));
      }
    return e2;
  }
    ...
    for (const n2 of t2) {
      ...
      switch (n2.type) {
        ...
        case "CIMGradientStroke": {
          const e3 = n2;
          let r3 = e3.width;
          e3.capStyle === U$3.Square || e3.joinStyle === w$3.Miter ? r3 /= 1.4142135623730951 : r3 /= 2, t3[0] = -r3, t3[1] = -r3, t3[2] = r3, t3[3] = r3;
          break;
        }
        case "CIMCharacterMarker":
        case "CIMVectorMarker":
        case "CIMPictureMarker": {
          ...
          if (e3.rotateClockwise && (s3 = -s3), a2 && (s3 -= a2), s3) {
            const e4 = J$1 * s3, r3 = Math.cos(e4), a3 = Math.sin(e4), o2 = u$8([n$e, n$e, -n$e, -n$e]);
            m$6(o2, [t3[0] * r3 - t3[1] * a3, t3[0] * a3 + t3[1] * r3]), m$6(o2, [t3[0] * r3 - t3[3] * a3, t3[0] * a3 + t3[3] * r3]), m$6(o2, [t3[2] * r3 - t3[1] * a3, t3[2] * a3 + t3[1] * r3]), m$6(o2, [t3[2] * r3 - t3[3] * a3, t3[2] * a3 + t3[3] * r3]), t3 = o2;
          }
  ...
  _getTextInflatedSize(e2, r2, a2) {
    ...
    if (!n2 || n2.glyphMosaicItems.length === 0)
      return e2;
    const l2 = tt(r2.lineGapType, (_b = r2.lineGap) != null ? _b : 0, o2), c2 = n$b(s2)[1], f2 = n2.glyphMosaicItems, m2 = j$1(f2, c2, { scale: o2 / j$4, angle: b$3(r2.angle), xOffset: b$3(r2.offsetX), yOffset: b$3(r2.offsetY), hAlign: Z$2(r2.horizontalAlignment), vAlign: $$2(r2.verticalAlignment), maxLineWidth: 512, lineHeight: f$7 * Math.max(0.25, Math.min(l2 || 1, 4)), decoration: r2.font.decoration || "none", isCIM: true }).boundsT;
...
class oe$1 {
  ...
  static fromSimpleFillSymbol(e2) {
    ...
    if (a2 && a2 !== "solid" && a2 !== "none" && a2 !== "esriSFSSolid" && a2 !== "esriSFSNull") {
      const e3 = { type: "CIMLineSymbol", symbolLayers: [{ type: "CIMSolidStroke", color: fe$1(t2), capStyle: U$3.Butt, joinStyle: w$3.Miter, width: 0.75 }] };
      let o3 = 0;
      const s3 = e$a(de(a2) ? 8 : 10);
      switch (a2) {
        case "vertical":
  ...
  static fromSimpleMarker(e2, t2, r2) {
    ...
    if (a2 === "path") {
      ...
      if ("outline" in e2 && e2.outline) {
        const r4 = e2.outline;
        t3.push({ type: "CIMSolidStroke", enable: true, width: u$a(Math.round(e$a(r4.width))), color: fe$1(r4.color) });
      }
    ...
    if (s2 && i2) {
      ...
      if ("outline" in e2 && e2.outline) {
        const t3 = e2.outline;
        r3.push({ type: "CIMSolidStroke", enable: true, width: t3.width > 0.667 ? u$a(Math.round(e$a(t3.width))) : t3.width, color: fe$1(t3.color) });
      } else
  ...
  static fromCIMInsidePolygon(e2) {
    ...
    if (t2.gridType === "Random") {
      const e3 = e$a(dt), r3 = Math.max(Math.floor(e3 / a2), 1), y2 = Math.max(Math.floor(e3 / o2), 1);
      n2 = r3 * a2 / 2, c2 = y2 * o2 / 2, f2 = 2 * c2;
      const h2 = new t$5(t2.seed), p2 = i2 * a2 / 1.5, u2 = i2 * o2 / 1.5;
      m2 = [];
  ...
  static async evaluateOverrides(e2, t2, r2, a2, o2) {
    ...
    for (const s2 of e2) {
      ...
      if (e3 && r2) {
        ...
        const n2 = o$9(e3.expression, r2.spatialReference, r2.fields).then((e4) => {
          s2.value = i$7(e4, t2, { $view: o2 }, r2.geometryType, a2);
        });
        i2.push(n2);
      }
    }
...
function i(t2) {
  return t2 ? t2.rings ? s(t2.rings) : t2.paths ? s(t2.paths) : u$7(t2) ? [t2.xmin, t2.ymin, t2.xmax, t2.ymax] : null : null;
}
...
function a(t2) {
  const o2 = l(t2.geom), n2 = e$1(o2), r2 = 128, s2 = 1, i2 = Math.floor(0.5 * (0.5 * r2 - s2)), f2 = (r2 - 2 * (i2 + s2)) / Math.max(n2.width, n2.height), a2 = Math.round(n2.width * f2) + 2 * i2, h2 = Math.round(n2.height * f2) + 2 * i2, y2 = [];
  for (const l2 of o2)
    if (l2 && l2.length > 1) {
      const o3 = [];
      for (const r3 of l2) {
...
class f {
  ...
  static applyEffects(e2, r2, c2) {
    ...
    let p2, u2 = null;
    for (; p2 = f2.next(); )
      u2 ? f$6(u2) ? f$6(p2) && u2.paths.push(...p2.paths) : y$4(u2) && y$4(p2) && u2.rings.push(...p2.rings) : u2 = p2;
    return u2;
  }
}
function e(e2, o2) {
...
const J = s$9.getLogger("esri.symbols.cim.cimAnalyzer");
function H(e2) {
  switch (e2) {
    case "Butt":
      return e$d.BUTT;
...
function E(e2) {
  ...
  return t2 && t2.angleToLine ? i$9.MAP : i$9.SCREEN;
}
async function T(e2, t2, i2, o2, n2) {
  ...
  if (a2 = e2.symbol, s2 = e2.primitiveOverrides, s2) {
    ...
    for (const i3 of s2) {
      ...
      if (o3 && t2) {
        const n3 = o3.expression, l3 = o$9(n3, t2.spatialReference, t2.fields).then((e4) => {
          t$9(e4) || $(c2, i3.primitiveName, i3.propertyName, e4);
        });
        e3.push(l3);
      } else
...
function j(e2, t2, i2, o2, r2, n2, l2) {
  ...
  e2.type === "CIMPointSymbol" && e2.angleAlignment === "Map" && (f2 = i$9.MAP);
  let y2 = a2.length;
  for (; y2--; ) {
    const m2 = a2[y2];
...
function D(e2, t2, i2, o2, r2, n2) {
  const l2 = e2.primitiveName, a2 = u$c(e2.color), [f2, c2] = pe(o2, l2, t2, null, null), m2 = c$8(JSON.stringify(e2) + c2).toString();
...
function F(e2, t2, i2, o2, r2, l2, a2) {
  const f2 = e2.primitiveName, c2 = e2.tintColor ? u$c(e2.tintColor) : { r: 255, g: 255, b: 255, a: 1 }, [m2, p2] = pe(o2, f2, t2, null, null), u2 = c$8(JSON.stringify(e2) + p2).toString(), y2 = c$8(`${e2.url}${JSON.stringify(e2.colorSubstitutions)}`).toString();
...
function U(e2, t2, i2, o2, r2, n2) {
  var _a;
  const l2 = ["Rotation", "OffsetX", "OffsetY"], a2 = o2.filter((t3) => t3.primitiveName !== e2.primitiveName || !l2.includes(t3.propertyName)), f2 = e2.primitiveName, [c2, m2] = pe(o2, f2, t2, null, null), p2 = c$8(JSON.stringify(e2) + m2).toString(), u2 = c$8(`${e2.separation}${JSON.stringify(e2.lineSymbol)}`).toString();
...
function W(e2, t2, i2, o2, r2, n2) {
  const l2 = e2.primitiveName, [a2, f2] = pe(o2, l2, t2, null, null), c2 = c$8(JSON.stringify(e2) + f2).toString();
...
function G(e2, t2, i2, o2, r2, n2, l2, a2) {
  const f2 = e2.primitiveName, c2 = u$c(e2.color), m2 = e2.width !== void 0 ? e2.width : 4, p2 = H(e2.capStyle), u2 = Y(e2.joinStyle), y2 = e2.miterLimit, [h2, g2] = pe(o2, f2, t2, null, null), d2 = c$8(JSON.stringify(e2) + g2).toString();
  let S2, N2;
...
function B(e2, t2, i2, o2, r2, n2, l2, a2) {
  const f2 = c$8(`${e2.url}${JSON.stringify(e2.colorSubstitutions)}`).toString(), c2 = e2.primitiveName, m2 = u$c(e2.tintColor), p2 = e2.width !== void 0 ? e2.width : 4, u2 = H(e2.capStyle), y2 = Y(e2.joinStyle), h2 = e2.miterLimit, [g2, d2] = pe(o2, c2, t2, null, null), S2 = c$8(JSON.stringify(e2) + d2).toString();
...
function q(e2, t2, i2, o2, r2, n2, l2, a2) {
  const f2 = e2.primitiveName, c2 = e2.width !== void 0 ? e2.width : 4, m2 = H(e2.capStyle), p2 = Y(e2.joinStyle), u2 = e2.miterLimit, [y2, h2] = pe(o2, f2, t2, null, null), g2 = c$8(JSON.stringify(e2) + h2).toString();
...
function V(e2, t2, i2, o2, r2, n2) {
  ...
  if (c2 === 0 || m2 === 0)
    return true;
  const p2 = ["Rotation", "OffsetX", "OffsetY"], u2 = o2.filter((t3) => t3.primitiveName !== e2.primitiveName || !p2.includes(t3.propertyName)), y2 = "url" in e2 ? e2.url : null, [h2, g2] = pe(o2, f2.primitiveName, t2, null, null), d2 = c$8(JSON.stringify(e2) + g2).toString();
  let S2, b2, O2 = null;
  if (l2.gridType === "Random") {
    const e3 = e$a(dt), t3 = Math.max(Math.floor(e3 / c2), 1), i3 = Math.max(Math.floor(e3 / m2), 1);
...
function _(e2, i2, o2, r2, n2, l2, a2, f2, c2, m2, u2) {
  ...
  if (!("x" in h2) || !("y" in h2))
    return;
  const g2 = r2.symbol, d2 = g$6(g2), S$1 = S(g2.fontStyleName), z2 = a$c(g2.fontFamilyName);
  g2.font = __spreadValues({ family: z2, decoration: d2 }, S$1);
  const A2 = e2.frame, R2 = h2.x - 0.5 * (A2.xmin + A2.xmax), x2 = h2.y - 0.5 * (A2.ymin + A2.ymax), J2 = e2.size / u2, H2 = e2.primitiveName, Y2 = b$3(g2.height) * J2, $2 = b$3(g2.angle), E2 = b$3(e2.offsetX) + (b$3(g2.offsetX) + R2) * J2, T2 = b$3(e2.offsetY) + (b$3(g2.offsetY) + x2) * J2, j2 = u$c(k$2(g2));
  let D2 = u$c(P$3(g2)), F2 = L$1(g2);
  F2 || (D2 = u$c(k$2(g2.haloSymbol)), F2 = g2.haloSize * J2);
  const [U2, W2] = pe(l2, H2, i2, o2, null), G2 = JSON.stringify(e2.effects) + Number(e2.colorLocked).toString() + JSON.stringify(e2.anchorPoint) + e2.anchorPointUnits + JSON.stringify(e2.markerPlacement) + e2.size.toString(), B2 = c$8(JSON.stringify(r2) + G2 + W2).toString();
  let q2 = ne(r2.primitiveName, n2, "TextString", a2, r2.textString, s$a, g2.textCase);
  if (q2 == null)
    return;
  const { fontStyleName: V2 } = g2, K2 = z2 + (V2 ? "-" + V2.toLowerCase() : "-regular"), Q2 = K2;
  typeof q2 == "string" && q2.includes("[") && g2.fieldMap && (q2 = c$9(g2.fieldMap, q2, g2.textCase)), f2.push({ type: "text", templateHash: B2, materialHash: U2 || typeof q2 == "function" || q2.match(/\[(.*?)\]/) ? (e3, t2, i3) => Q2 + "-" + t$a(q2, e3, t2, i3) : Q2 + "-" + c$8(q2), cim: g2, materialOverrides: null, colorLocked: e2.colorLocked, effects: i2, alignment: c2, anchorPoint: { x: e2.anchorPoint ? e2.anchorPoint.x : 0, y: e2.anchorPoint ? e2.anchorPoint.y : 0 }, isAbsoluteAnchorPoint: e2.anchorPointUnits !== "Relative", fontName: K2, decoration: d2, weight: ne(H2, n2, "Weight", a2, S$1.weight), style: ne(H2, n2, "Size", a2, S$1.style), size: ne(H2, n2, "Size", a2, Y2), angle: ne(H2, n2, "Rotation", a2, $2), offsetX: ne(H2, n2, "OffsetX", a2, E2), offsetY: ne(H2, n2, "OffsetY", a2, T2), horizontalAlignment: w$4(g2.horizontalAlignment), verticalAlignment: x$3(g2.verticalAlignment), text: q2, color: j2, outlineColor: D2, outlineSize: F2, referenceSize: m2, sizeRatio: 1, markerPlacement: o2 });
}
function Z(e2, t2, i$12, o2, r2, l2, a2, f$22, c2, m2, p2, u2, y2, h2) {
  var _a;
  const g2 = r2.symbol, b2 = g2.symbolLayers;
  if (!b2)
    return;
  if (h2)
    return void te(e2, t2, i$12, o2, r2, a2, l2, f$22, c2, m2, p2, u2, y2);
  let O2 = b2.length;
  if (ue(b2))
    return void ee(e2, t2, i$12, o2, r2, b2, l2, a2, f$22, c2, p2, u2, y2);
      ...
      if (h3 && h3.enable !== false)
        switch (h3.type) {
          ...
          case "CIMSolidStroke": {
            ...
            const W2 = JSON.stringify(__spreadProps(__spreadValues({}, e2), { markerGraphics: null })), G2 = c$8(JSON.stringify(A2) + $2).toString(), B2 = { type: "marker", templateHash: c$8(JSON.stringify(r2) + JSON.stringify(h3) + W2 + U2).toString(), materialHash: F2 ? () => G2 : G2, cim: A2, materialOverrides: null, colorLocked: e2.colorLocked, effects: t2, scaleSymbolsProportionally: e2.scaleSymbolsProportionally, alignment: p2, anchorPoint: { x: w2, y: I2 }, isAbsoluteAnchorPoint: O3, size: ne(e2.primitiveName, a2, "Size", f$22, x2), rotation: ne(e2.primitiveName, a2, "Rotation", f$22, J2), offsetX: ne(e2.primitiveName, a2, "OffsetX", f$22, H2), offsetY: ne(e2.primitiveName, a2, "OffsetY", f$22, Y2), scaleX: 1, frameHeight: y2, rotateClockwise: e2.rotateClockwise, referenceSize: u2, sizeRatio: L2, color: ne(E2, a2, "Color", f$22, T2, re), outlineColor: ne(E2, a2, "Color", f$22, j2, re), outlineWidth: ne(E2, a2, "Width", f$22, D2), markerPlacement: i$12, animatedSymbolProperties: o2, path: $2 };
            c2.push(B2);
            break;
          }
          default:
            te(e2, t2, i$12, o2, r2, a2, l2, f$22, c2, m2, p2, u2, y2);
        }
    }
}
function ee(e2, t2, i$12, o2, r2, n2, l2, a2, f2, c2, m2, p2, u2) {
  const y2 = r2.geometry, h2 = n2[0], g2 = n2[1], b2 = i(y2);
  if (!b2)
    return;
  const O2 = e2.anchorPointUnits !== "Relative", [M2, L2, w2] = f$1(b2, e2.frame, e2.size, e2.anchorPoint, O2), I2 = { type: "sdf", geom: y2, asFill: true }, X2 = e2.primitiveName, z2 = b$3(e2.size), A2 = b$3(e2.rotation), R2 = b$3(e2.offsetX), x2 = b$3(e2.offsetY), J2 = g2.path, H2 = g2.primitiveName, Y2 = h2.primitiveName, $2 = u$c(k$2(g2)), E2 = u$c(P$3(h2)), T2 = L$1(h2);
  let j2 = false, D2 = "";
  for (const s2 of l2)
...
function ne(e2, t2, i2, o2, r2, n2, l2) {
  ...
  if (a2) {
    ...
    if (e3 != null && e3 instanceof p$4)
      return (t3, i3, a3) => {
        let s2 = i$7(e3, t3, { $view: a3 }, o2.geometryType, i3);
...
function ae(e2, t2, o2, r2) {
  for (const i2 of t2) {
    if (i2.valueExpressionInfo) {
      ...
      e3 instanceof p$4 && (i2.fn = (t3, i3, o3) => i$7(e3, t3, { $view: o3 }, r2.geometryType, i3));
    }
  }
  return (o3, r3, n2) => {
    for (const e3 of t2)
...
function ce(e2, t2, i2, o2) {
  for (const r2 of i2) {
    if (r2.valueExpressionInfo) {
      ...
      e3 instanceof p$4 && (r2.fn = (t3, i3, r3) => i$7(e3, t3, { $view: r3 }, o2.geometryType, i3));
    }
  }
  return (t3, o3, r2) => {
    for (const e3 of i2)
      e3.fn && (e3.value = e3.fn(t3, o3, r2));
    return c$8(e2 + ie$1.buildOverrideKey(i2)).toString();
  };
}
function me(e2, t2) {
  if (!t2 || t2.length === 0)
...
export { O, Q$1 as Q, T, V$1 as V, W$2 as W, ae$1 as a, oe$1 as b, a as c, a$9 as d, e, f, g$1 as g, ie$1 as i, j$1 as j, me as m, n$b as n, o, pe$1 as p, r$1 as r, s$1 as s, t$1 as t };
