...
import { aU as l$8, o as y$3, iA as y$4, iR as f$7, iW as l$9, iV as s$7, iS as u$8, j7 as O$1, j8 as P$3, j9 as R$1, ja as k$2, jb as B$2, dO as u$9, iN as c$9, jc as A$2, jd as X, je as o$6, jf as Y$3, jg as t$6, jh as Z$3, ji as M$2, jj as s$8, jk as u$a, jl as i$7, jm as G$3, dN as o$7, e as e$9, jn as s$9, jo as K$3, cJ as has, jp as g$6, f6 as u$b, fV as t$7, e5 as n$d, jq as h$6, jr as n$e, js as o$8, b0 as r$g, jt as z$1, ju as i$8, jv as e$a, jw as a$d, dH as s$a, jx as o$9, r as r$h, x as t$a, gm as e$b, jy as U$3, jz as w$4, dA as e$d, iB as r$i, jA as C$3, jB as l$a, jC as a$e, jD as u$c, jE as y$5, jF as ne$2, jG as oe$2, jH as m$5, jI as ie$2, gJ as m$6, gk as o$a, jJ as c$a, jK as i$a, jL as p$4, j4 as e$e, j5 as n$g } from "./index.js";
import { C as C$2 } from "./BidiEngine.js";
import { t as t$9, e as e$c } from "./alignmentUtils.js";
import { j as j$4, f as f$8, d as dt } from "./definitions.js";
import { w as w$3 } from "./number.js";
import { t as t$8 } from "./Rect.js";
import { i as i$9 } from "./callExpressionWithFeature.js";
...
function c$8(e2, t2, r2) {
  const n2 = i$6(t2, e2);
  return (e3) => l$7(e3, n2, r2);
}
function s$6(e2, t2) {
...
class a$a {
  ...
  tintImageData(a2, e2) {
    ...
    const s2 = i2.getImageData(0, 0, n2, o2), l2 = new Uint8Array(s2.data), g2 = new l$8(e2), h2 = [g2.r / 255, g2.g / 255, g2.b / 255, g2.a];
...
function l$6(t2) {
  t2 && (s$7(t2) ? t2.y = -t2.y : y$4(t2) ? u$6(t2.rings) : f$7(t2) ? u$6(t2.paths) : l$9(t2) && r$d(t2.points));
}
function r$d(t2) {
  if (t2) {
    const i2 = t2.length;
...
function P$1(t2) {
  t2 && (y$4(t2) ? m$3(t2.rings) : f$7(t2) ? m$3(t2.paths) : l$9(t2) && p$2(t2.points), l$6(t2));
}
function x$2(t2) {
  t2 && (l$6(t2), y$4(t2) ? f$5(t2.rings) : f$7(t2) ? f$5(t2.paths) : l$9(t2) && c$6(t2.points));
}
function g$4(t2) {
  if (t2)
    for (const i2 of t2)
...
class G$1 {
  constructor(t2, s2, e2, a2 = 0) {
    this.isClosed = false, this.multiPath = null, this.acceptPolygon = s2, this.acceptPolyline = e2, this.geomUnitsPerPoint = a2, this.pathCount = -1, this.pathIndex = -1, this.iteratePath = false, t2 && (y$4(t2) ? s2 && (this.multiPath = t2.rings, this.isClosed = true) : f$7(t2) ? e2 && (this.multiPath = t2.paths, this.isClosed = false) : u$8(t2) && s2 && (this.multiPath = b$2(t2).rings, this.isClosed = true), this.multiPath && (this.pathCount = this.multiPath.length)), this.internalPlacement = new t$4();
  }
  next() {
    if (!this.multiPath)
      return null;
  ...
  next() {
    for (; ; ) {
      if (!this.multiPath) {
        ...
        for (; t2; ) {
          if (y$4(t2) ? this.acceptPolygon && (this.multiPath = t2.rings, this.isClosed = true) : f$7(t2) ? this.acceptPolyline && (this.multiPath = t2.paths, this.isClosed = false) : u$8(t2) && this.acceptPolygon && (this.multiPath = b$2(t2).rings, this.isClosed = true), this.multiPath) {
...
const l$5 = 1.7320508075688772, c$5 = 5, u$5 = P$3.OpenEnded;
class h$4 {
  static local() {
...
class h$3 {
  ...
  next() {
    ...
    for (; n2; ) {
      ...
      s$7(n2) && this._size, n2 = this._inputGeometries.next();
    }
    return null;
  }
}
...
class c$4 {
  ...
  next() {
    ...
    for (; e2 = this._inputGeometries.next(); ) {
      let r2;
      if (s$7(e2) ? r2 = this._processGeom([[[e2.x, e2.y]]]) : l$9(e2) ? r2 = this._processGeom([e2.points]) : f$7(e2) ? r2 = this._processGeom(e2.paths) : y$4(e2) && (r2 = this._processGeom(e2.rings)), r2 && r2.length)
        return { paths: r2 };
    }
    return null;
  }
...
function u$2(t2) {
  ...
  if (Math.abs(f2) <= 2 * c2 * c2) {
    const t3 = s$8(u$9(), n2[l2]);
    return [(t3[0] + t3[2]) / 2, (t3[1] + t3[3]) / 2];
  }
  const u2 = u$a(n2[l2], false, u$9());
  if (u2 === null)
    return null;
...
function g$2(t2, n2, i2, r2) {
  ...
  const N2 = [[n2, r2[1] - 1], [n2, r2[3] + 1]], u2 = [0, 0], h2 = [0, 0], m2 = [0, 0], g2 = [[0, 0], [0, 0]], x2 = u$9(), { rings: M2 } = t2;
  for (const e2 of M2)
    if (!(e2.length < 2))
...
class k {
  constructor(t2, n2, e2, i2) {
    this.x = t2, this.y = n2, this.cellSize = e2, this.distancefromCellCenter = s$9(t2, n2, i2), this.maxDistanceToPolygon = this.distancefromCellCenter + this.cellSize * Math.SQRT2;
  }
}
const P = 1, T$2 = 100;
function z(i2) {
  ...
  _polygonCenter(r2) {
    ...
    switch (this._method) {
      ...
      case K$3.BoundingBoxCenter:
        {
          const s2 = u$9();
          c$9(s2, r2), s2 && (this._internalPlacement.setTranslate((s2[2] + s2[0]) / 2 + this._offsetX, (s2[3] + s2[1]) / 2 + this._offsetY), l2 = true);
        }
        break;
      case K$3.OnPolygon:
      default: {
...
class s$1 {
  ...
  _setFontProperties(e2, i2) {
    const s2 = Math.max(i2.size, 0.5), n2 = i2.font, r2 = `${n2.style} ${n2.weight} ${u$b(s2 * i2.pixelRatio).toFixed(1)}px ${n2.family}, sans-serif`;
    let o2;
...
class T$1 {
  ...
  get boundsT() {
    const t2 = this.bounds, s2 = r$g(n$d(), t2.x, t2.y);
  ...
  _createGlyphTransform(t2, s2) {
    ...
    return i$8(r2, r2, r$g(c2, s2.xOffset, -s2.yOffset)), s2.isCIM ? e$a(r2, r2, o2) : (i$8(r2, r2, r$g(c2, t2.x, t2.y)), e$a(r2, r2, o2), i$8(r2, r2, r$g(c2, -t2.x, -t2.y))), r2;
  }
}
class B$1 {
...
function j$1(t2, s2, e2) {
  const i2 = e2.scale, n2 = new Array(), o2 = L(t2, s2, e2), h2 = v(o2, e2), { vAlign: r2, hAlign: a2 } = e2, f2 = r2 === t$9.Baseline ? 1 : 0, d2 = f2 ? 0 : r2 - 1, m2 = (1 - f2) * -h2.y + d2 * (h2.height / 2) + (f2 ? 1 : 0) * -l$1;
...
const E$1 = Math.PI / 180, J$2 = 10, N = s$a.getLogger("esri.symbols.cim.CIMSymbolDrawHelper");
class O {
  constructor(t2) {
    this._t = t2;
  }
...
class Y$2 {
  ...
  drawMarkerLayer(t2, e2) {
    ...
    if (r2) {
      ...
      if (s$7(e2))
        ...
        [r3.tx, r3.ty] = r$i(e2), this.drawMarker(t2, r3);
      else
  ...
  _buildHatchPolyline(t2, e2, r2) {
    ...
    for (; o2 < -n2; )
      o2 += i2;
    const a2 = u$9();
    c$9(a2, e2), a2[0] -= n2, a2[1] -= n2, a2[2] += n2, a2[3] += n2;
...
class q$2 extends Y$2 {
  ...
  drawImage(t2, e2) {
    ...
    !e2 && r$h(a2) && (s2 = i2 * a2.width, n2 = a2.height), this._merge(this.transformPt([-s2 / 2, -n2 / 2]), 0), this._merge(this.transformPt([-s2 / 2, n2 / 2]), 0), this._merge(this.transformPt([s2 / 2, -n2 / 2]), 0), this._merge(this.transformPt([s2 / 2, n2 / 2]), 0);
  }
  drawText(t2, e2) {
    if (!e2 || e2.length === 0)
      return;
...
class W$2 extends Y$2 {
  ...
  drawPictureStroke(t2, e2) {
    ...
    const w2 = Math.max(this.transformSize(u$b(m2)), 0.5), x2 = w2 / P2.width, S2 = this._ctx, M2 = S2.createPattern(P2, "repeat-y");
    let b2, C2;
...
const Y$1 = Math.PI, $$1 = Y$1 / 2, U$1 = 4, q$1 = 10, W$1 = 96 / 72, J$1 = Math.PI / 180, K$1 = s$a.getLogger("esri.symbols.cim.CIMSymbolHelper");
function Q$1(e2) {
  if (!e2 || !e2.type)
    return null;
  let t2;
  ...
  _vectorMarkerBounds(e2, t2, r2, a2) {
    ...
    if (t2 && t2.markerGraphics)
      for (const s2 of t2.markerGraphics) {
        const t3 = [0, 0, 0, 0];
        s2.geometry && (c$9(i2, s2.geometry), t3[0] = 0, t3[1] = 0, t3[2] = 0, t3[3] = 0, this.getSymbolInflateSize(t3, s2.symbol, r2, 0, a2), i2[0] += t3[0], i2[1] += t3[1], i2[2] += t3[2], i2[3] += t3[3], o2 ? (e2[0] = i2[0], e2[1] = i2[1], e2[2] = i2[2], e2[3] = i2[3], o2 = false) : (e2[0] = Math.min(e2[0], i2[0]), e2[1] = Math.min(e2[1], i2[1]), e2[2] = Math.max(e2[2], i2[2]), e2[3] = Math.max(e2[3], i2[3])));
      }
    return e2;
  }
      ...
      switch (n2.type) {
        ...
        case "CIMPictureMarker": {
          ...
          if (n2.type === "CIMVectorMarker") {
            ...
            let s4 = 1;
            r$h(i3) && i3.height && (s4 = i3.width / i3.height);
          ...
          if (e3.rotateClockwise && (s3 = -s3), a2 && (s3 -= a2), s3) {
            const e4 = J$1 * s3, r3 = Math.cos(e4), a3 = Math.sin(e4), o2 = u$9([n$f, n$f, -n$f, -n$f]);
  ...
  static fromSimpleMarker(e2, t2, r2) {
    ...
    if (a2 === "path") {
      ...
      if ("outline" in e2 && e2.outline) {
        const r4 = e2.outline;
        t3.push({ type: "CIMSolidStroke", enable: true, width: u$b(Math.round(e$b(r4.width))), color: fe$1(r4.color) });
      }
    ...
    if (s2 && i2) {
      ...
      if ("outline" in e2 && e2.outline) {
        const t3 = e2.outline;
        r3.push({ type: "CIMSolidStroke", enable: true, width: t3.width > 0.667 ? u$b(Math.round(e$b(t3.width))) : t3.width, color: fe$1(t3.color) });
      } else
    ...
    for (const s2 of e2) {
      ...
      if (e3 && r2) {
        ...
        const n2 = o$a(e3.expression, r2.spatialReference, r2.fields).then((e4) => {
          s2.value = i$9(e4, t2, { $view: o2 }, r2.geometryType, a2);
        });
        i2.push(n2);
      }
    }
...
function Ce(e2, t2, r2) {
  if (!e2.effects || r$h(t2.geometryEngine))
    return;
  if (be)
...
function i(t2) {
  return t2 ? t2.rings ? s(t2.rings) : t2.paths ? s(t2.paths) : u$8(t2) ? [t2.xmin, t2.ymin, t2.xmax, t2.ymax] : null : null;
}
...
const J = s$a.getLogger("esri.symbols.cim.cimAnalyzer");
function H(e2) {
  switch (e2) {
    case "Butt":
      return e$e.BUTT;
...
function E(e2) {
  ...
  return t2 && t2.angleToLine ? i$a.MAP : i$a.SCREEN;
}
...
function j(e2, t2, i2, o2, r2, n2, l2) {
  ...
  e2.type === "CIMPointSymbol" && e2.angleAlignment === "Map" && (f2 = i$a.MAP);
  let y2 = a2.length;
  for (; y2--; ) {
    const m2 = a2[y2];
...
function D(e2, t2, i2, o2, r2, n2) {
  const l2 = e2.primitiveName, a2 = u$7(e2.color), [f2, c2] = pe(o2, l2, t2, null, null), m2 = c$a(JSON.stringify(e2) + c2).toString();
...
function F(e2, t2, i2, o2, r2, l2, a2) {
  const f2 = e2.primitiveName, c2 = e2.tintColor ? u$7(e2.tintColor) : { r: 255, g: 255, b: 255, a: 1 }, [m2, p2] = pe(o2, f2, t2, null, null), u2 = c$a(JSON.stringify(e2) + p2).toString(), y2 = c$a(`${e2.url}${JSON.stringify(e2.colorSubstitutions)}`).toString();
  let h2 = b$3(e2.scaleX);
  if ("width" in e2) {
    const t3 = e2.width;
    let i3 = 1;
    const o3 = l2.getResource(e2.url);
    r$h(o3) && (i3 = o3.width / o3.height), h2 /= i3 * (e2.height / t3);
  }
...
function U(e2, t2, i2, o2, r2, n2) {
  var _a;
  const l2 = ["Rotation", "OffsetX", "OffsetY"], a2 = o2.filter((t3) => t3.primitiveName !== e2.primitiveName || !l2.includes(t3.propertyName)), f2 = e2.primitiveName, [c2, m2] = pe(o2, f2, t2, null, null), p2 = c$a(JSON.stringify(e2) + m2).toString(), u2 = c$a(`${e2.separation}${JSON.stringify(e2.lineSymbol)}`).toString();
...
function W(e2, t2, i2, o2, r2, n2) {
  const l2 = e2.primitiveName, [a2, f2] = pe(o2, l2, t2, null, null), c2 = c$a(JSON.stringify(e2) + f2).toString();
...
function G(e2, t2, i2, o2, r2, n2, l2, a2) {
  const f2 = e2.primitiveName, c2 = u$7(e2.color), m2 = e2.width !== void 0 ? e2.width : 4, p2 = H(e2.capStyle), u2 = Y(e2.joinStyle), y2 = e2.miterLimit, [h2, g2] = pe(o2, f2, t2, null, null), d2 = c$a(JSON.stringify(e2) + g2).toString();
  let S2, N2;
...
function B(e2, t2, i2, o2, r2, n2, l2, a2) {
  const f2 = c$a(`${e2.url}${JSON.stringify(e2.colorSubstitutions)}`).toString(), c2 = e2.primitiveName, m2 = u$7(e2.tintColor), p2 = e2.width !== void 0 ? e2.width : 4, u2 = H(e2.capStyle), y2 = Y(e2.joinStyle), h2 = e2.miterLimit, [g2, d2] = pe(o2, c2, t2, null, null), S2 = c$a(JSON.stringify(e2) + d2).toString();
...
function q(e2, t2, i2, o2, r2, n2, l2, a2) {
  const f2 = e2.primitiveName, c2 = e2.width !== void 0 ? e2.width : 4, m2 = H(e2.capStyle), p2 = Y(e2.joinStyle), u2 = e2.miterLimit, [y2, h2] = pe(o2, f2, t2, null, null), g2 = c$a(JSON.stringify(e2) + h2).toString();
...
function V(e2, t2, i2, o2, r2, n2) {
  ...
  if (c2 === 0 || m2 === 0)
    return true;
  const p2 = ["Rotation", "OffsetX", "OffsetY"], u2 = o2.filter((t3) => t3.primitiveName !== e2.primitiveName || !p2.includes(t3.propertyName)), y2 = "url" in e2 ? e2.url : null, [h2, g2] = pe(o2, f2.primitiveName, t2, null, null), d2 = c$a(JSON.stringify(e2) + g2).toString();
  let S2, b2, O2 = null;
...
function _(e2, i2, o2, r2, n2, l2, a2, f2, c2, m2, u2) {
  ...
  if (!("x" in h2) || !("y" in h2))
    return;
  const g2 = r2.symbol, d2 = g$5(g2), S$1 = S(g2.fontStyleName), z2 = a$b(g2.fontFamilyName);
  g2.font = __spreadValues({ family: z2, decoration: d2 }, S$1);
  const A2 = e2.frame, R2 = h2.x - 0.5 * (A2.xmin + A2.xmax), x2 = h2.y - 0.5 * (A2.ymin + A2.ymax), J2 = e2.size / u2, H2 = e2.primitiveName, Y2 = b$3(g2.height) * J2, $2 = b$3(g2.angle), E2 = b$3(e2.offsetX) + (b$3(g2.offsetX) + R2) * J2, T2 = b$3(e2.offsetY) + (b$3(g2.offsetY) + x2) * J2, j2 = u$7(k$1(g2));
  let D2 = u$7(P$2(g2)), F2 = L$1(g2);
  F2 || (D2 = u$7(k$1(g2.haloSymbol)), F2 = g2.haloSize * J2);
  const [U2, W2] = pe(l2, H2, i2, o2, null), G2 = JSON.stringify(e2.effects) + Number(e2.colorLocked).toString() + JSON.stringify(e2.anchorPoint) + e2.anchorPointUnits + JSON.stringify(e2.markerPlacement) + e2.size.toString(), B2 = c$a(JSON.stringify(r2) + G2 + W2).toString();
  let q2 = ne(r2.primitiveName, n2, "TextString", a2, r2.textString, s$6, g2.textCase);
  if (q2 == null)
    return;
  const { fontStyleName: V2 } = g2, K2 = z2 + (V2 ? "-" + V2.toLowerCase() : "-regular"), Q2 = K2;
  typeof q2 == "string" && q2.includes("[") && g2.fieldMap && (q2 = c$8(g2.fieldMap, q2, g2.textCase)), f2.push({ type: "text", templateHash: B2, materialHash: U2 || typeof q2 == "function" || q2.match(/\[(.*?)\]/) ? (e3, t2, i3) => Q2 + "-" + t$5(q2, e3, t2, i3) : Q2 + "-" + c$a(q2), cim: g2, materialOverrides: null, colorLocked: e2.colorLocked, effects: i2, alignment: c2, anchorPoint: { x: e2.anchorPoint ? e2.anchorPoint.x : 0, y: e2.anchorPoint ? e2.anchorPoint.y : 0 }, isAbsoluteAnchorPoint: e2.anchorPointUnits !== "Relative", fontName: K2, decoration: d2, weight: ne(H2, n2, "Weight", a2, S$1.weight), style: ne(H2, n2, "Size", a2, S$1.style), size: ne(H2, n2, "Size", a2, Y2), angle: ne(H2, n2, "Rotation", a2, $2), offsetX: ne(H2, n2, "OffsetX", a2, E2), offsetY: ne(H2, n2, "OffsetY", a2, T2), horizontalAlignment: w$2(g2.horizontalAlignment), verticalAlignment: x$3(g2.verticalAlignment), text: q2, color: j2, outlineColor: D2, outlineSize: F2, referenceSize: m2, sizeRatio: 1, markerPlacement: o2 });
}
...
function ee(e2, t2, i$12, o2, r2, n2, l2, a2, f2, c2, m2, p2, u2) {
  ...
  if (!b2)
    return;
  const O2 = e2.anchorPointUnits !== "Relative", [M2, L2, w2] = f$1(b2, e2.frame, e2.size, e2.anchorPoint, O2), I2 = { type: "sdf", geom: y2, asFill: true }, X2 = e2.primitiveName, z2 = b$3(e2.size), A2 = b$3(e2.rotation), R2 = b$3(e2.offsetX), x2 = b$3(e2.offsetY), J2 = g2.path, H2 = g2.primitiveName, Y2 = h2.primitiveName, $2 = u$7(k$1(g2)), E2 = u$7(P$2(h2)), T2 = L$1(h2);
  let j2 = false, D2 = "";
  for (const s2 of l2)
...
function te(e2, t2, i2, o2, r2, a2, f2, c2, p2, u2, y2, h2, g2) {
  ...
  const [O2, k2, C2] = oe$1.getTextureAnchor(d2, u2), P2 = e2.primitiveName, M2 = b$3(e2.rotation), L2 = b$3(e2.offsetX), w2 = b$3(e2.offsetY), I2 = c$a(JSON.stringify(d2) + b2).toString(), X2 = { type: "marker", templateHash: I2, materialHash: v2.length > 0 || r$h(t2) && typeof t2 == "function" ? ce(I2, a2, v2, c2) : I2, cim: d2, materialOverrides: v2, colorLocked: e2.colorLocked, effects: t2, scaleSymbolsProportionally: e2.scaleSymbolsProportionally, alignment: y2, anchorPoint: { x: O2, y: k2 }, isAbsoluteAnchorPoint: false, size: e2.size, rotation: ne(P2, a2, "Rotation", c2, M2), offsetX: ne(P2, a2, "OffsetX", c2, L2), offsetY: ne(P2, a2, "OffsetY", c2, w2), color: { r: 255, g: 255, b: 255, a: 1 }, outlineColor: { r: 0, g: 0, b: 0, a: 0 }, outlineWidth: 0, scaleX: 1, frameHeight: g2, rotateClockwise: e2.rotateClockwise, referenceSize: h2, sizeRatio: C2 / u$b(e2.size), markerPlacement: i2, animatedSymbolProperties: o2 };
  p2.push(X2);
}
function ie(e2, t2) {
...
function ne(e2, t2, i2, o2, r2, n2, l2) {
  ...
  if (a2) {
    ...
    if (e3 != null && e3 instanceof p$4)
      return (t3, i3, a3) => {
        let s2 = i$9(e3, t3, { $view: a3 }, o2.geometryType, i3);
...
function ae(e2, t2, o2, r2) {
  for (const i2 of t2) {
    if (i2.valueExpressionInfo) {
      ...
      e3 instanceof p$4 && (i2.fn = (t3, i3, o3) => i$9(e3, t3, { $view: o3 }, r2.geometryType, i3));
    }
  }
  return (o3, r3, n2) => {
    for (const e3 of t2)
...
function ce(e2, t2, i2, o2) {
  for (const r2 of i2) {
    if (r2.valueExpressionInfo) {
      ...
      e3 instanceof p$4 && (r2.fn = (t3, i3, r3) => i$9(e3, t3, { $view: r3 }, o2.geometryType, i3));
    }
  }
  return (t3, o3, r2) => {
    for (const e3 of i2)
      e3.fn && (e3.value = e3.fn(t3, o3, r2));
    return c$a(e2 + ie$1.buildOverrideKey(i2)).toString();
  };
}
function me(e2, t2) {
  if (!t2 || t2.length === 0)
...
function pe(e2, t2, i2, o2, r2) {
  ...
  return r$h(i2) && typeof i2 == "function" && (l2 = true), r$h(o2) && typeof o2 == "function" && (l2 = true), r$h(r2) && typeof r2 == "function" && (l2 = true), [l2, a2];
}
...
export { G$2 as G, O, Q$1 as Q, T, V$1 as V, W$2 as W, ae$1 as a, oe$1 as b, a$c as c, a as d, e, a$9 as f, g$1 as g, f as h, i$5 as i, j$1 as j, t$5 as k, m$4 as l, me as m, n$b as n, o, pe$1 as p, ie$1 as q, r$1 as r, s$1 as s, t$1 as t, c$8 as u, r$f as v };
