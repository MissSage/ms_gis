import { p as proxyCustomElement, H, c as createEvent, h, t as toAriaBoolean, m7 as getSlotted, a as Host } from "./index.js";
import { H as Heading, d as defineCustomElement$5, a as defineCustomElement$7 } from "./action-menu.js";
...
const Handle = /* @__PURE__ */ proxyCustomElement(class extends H {
  ...
  render() {
    return h("span", { "aria-pressed": toAriaBoolean(this.activated), class: { [CSS$1.handle]: true, [CSS$1.handleActivated]: this.activated }, onBlur: this.handleBlur, onKeyDown: this.handleKeyDown, ref: (el) => {
      this.handleButton = el;
    }, role: "button", tabindex: "0", title: this.textTitle }, h("calcite-icon", { icon: ICONS$1.drag, scale: "s" }));
  }
  get el() {
    return this;
  }
...
const Block = /* @__PURE__ */ proxyCustomElement(class extends H {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
