import { x as t, dA as e, dH as s$1, ew as s$2, j4 as e$1, j5 as n } from "./index.js";
import { x as x$1 } from "./number.js";
...
function te(t2) {
  switch (t2) {
    ...
    case "round":
      return n.ROUND;
    default:
      return E.error(new s$2("mapview-invalid-type", `Join type ${t2} is not a valid option. Defaulting to round`)), n.ROUND;
  }
}
function re(e2) {
  switch (e2) {
