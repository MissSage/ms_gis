import { p as proxyCustomElement, H, c as createEvent, g as getElementDir, h, t as toAriaBoolean, m9 as Fragment } from "./index.js";
import { H as Heading, S as SLOTS$1, d as defineCustomElement$2, a as defineCustomElement$5 } from "./action-menu.js";
...
const Panel = /* @__PURE__ */ proxyCustomElement(class extends H {
  ...
  renderBackButton() {
    ...
    return showBackButton ? h("calcite-action", { "aria-label": label, class: CSS.backButton, icon, key: "back-button", onClick: backButtonClick, ref: this.setBackRef, scale: "s", slot: SLOTS.headerActionsStart, text: label }) : null;
  }
  renderHeaderContent() {
