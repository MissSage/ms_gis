import { ea as s, rE as x, rF as n, a2 as t, s as s$1, rG as L, rH as S, oq as ie, aD as m$1, rI as _ } from "./index.js";
import "vue";
...
async function m(r, a, n$1) {
  if (!r || !r.symbol)
    return f;
  const o = r.where, i = x(r), m2 = o ? await import("./index.js").then(function(n2) {
    return n2.su;
  }) : null;
  let g;
  if (i.type === "arcade") {
