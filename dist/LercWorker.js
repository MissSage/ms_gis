    ...
    if (p !== 0)
      for (var w = 0; w <= f2; w++) {
        ...
        if (y !== 0) {
          ...
          if (b.encoding < 2 ? (b.encoding === 0 ? V = b.rawData : (s(b.stuffedData, b.bitsPerPixel, b.numValidPixels, b.offset, c, k, e.pixels.maxValue), V = k), B = 0) : v = b.encoding === 2 ? 0 : b.offset, i2)
            for (h = 0; h < p; h++) {
      ...
      if (V.encoding !== 2) {
        if (B !== 0 && B !== 2) {
          ...
          if (h = Math.min(V.offset, h), V.encoding === 1)
            if (B = l2.getUint8(w), w++, V.bitsPerPixel = 63 & B, B >>= 6, V.numValidPixelsType = B, B === 2)
