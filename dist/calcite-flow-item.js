...
import { gP as h, gN as proxyCustomElement, gO as H, gR as createEvent, gS as toAriaBoolean, gT as forceUpdate, gU as queryElementRoots, gV as Host, gW as isPrimaryPointerButton, gX as focusElement, gY as Fragment, gZ as getElementDir } from "./index.js";
import { g as guid } from "./guid.js";
import { d as defineCustomElement$6, a as defineCustomElement$8 } from "./action.js";
import { d as defineCustomElement$7 } from "./icon.js";
import { d as defaultOffsetDistance, f as filterComputedPlacements, c as connectFloatingUI, u as updateAfterClose, a as disconnectFloatingUI, r as reposition, F as FloatingCSS, b as defineCustomElement$9 } from "./tooltip.js";
...
const Popover = /* @__PURE__ */ proxyCustomElement(class extends H {
  ...
  renderCloseButton() {
    ...
    return closable || closeButton ? h("div", { class: CSS$4.closeButtonContainer }, h("calcite-action", { class: CSS$4.closeButton, onClick: this.hide, ref: (closeButtonEl) => this.closeButtonEl = closeButtonEl, scale: heading ? "s" : "m", text: intlClose }, h("calcite-icon", { icon: "x", scale: heading ? "s" : "m" }))) : null;
  }
  renderHeader() {
    const { heading, headingLevel } = this;
    const headingNode = heading ? h(Heading, { class: CSS$4.heading, level: headingLevel || HEADING_LEVEL$1 }, heading) : null;
    return headingNode ? h("div", { class: CSS$4.header }, headingNode, this.renderCloseButton()) : null;
  }
  render() {
    const { effectiveReferenceElement, heading, label, open, disablePointer } = this;
    const displayed = effectiveReferenceElement && open;
    const hidden = !displayed;
    const arrowNode = !disablePointer ? h("div", { class: CSS$4.arrow, ref: this.storeArrowEl }) : null;
    return h(Host, { "aria-hidden": toAriaBoolean(hidden), "aria-label": label, "aria-live": "polite", "calcite-hydrated-hidden": hidden, id: this.getId(), role: "dialog" }, h("div", { class: {
      ...
      [CSS$4.hasHeader]: !!heading,
      [CSS$4.container]: true
    } }, this.renderHeader(), h("div", { class: CSS$4.content }, h("slot", null)), !heading ? this.renderCloseButton() : null)));
  }
  get el() {
    return this;
  }
...
const ActionMenu = /* @__PURE__ */ proxyCustomElement(class extends H {
  ...
  renderMenuButton() {
    ...
    const menuButtonSlot = h("slot", { name: SLOTS$2.trigger, onSlotchange: this.setMenuButtonEl }, h("calcite-action", { class: CSS$3.defaultTrigger, icon: ICONS$2.menu, ref: this.setDefaultMenuButtonEl, scale, text: label, textEnabled: expanded }));
...
const Scrim = /* @__PURE__ */ proxyCustomElement(class extends H {
  constructor() {
    ...
    this.__registerHost();
    this.__attachShadow();
    this.intlLoading = TEXT$2.loading;
    this.loading = false;
  }
  render() {
    ...
    const contentNode = hasContent ? h("div", { class: CSS$2.content }, h("slot", null)) : null;
    return h("div", { class: CSS$2.scrim }, loaderNode, contentNode);
  }
  get el() {
    return this;
  }
...
const Panel = /* @__PURE__ */ proxyCustomElement(class extends H {
  ...
  renderBackButton() {
    ...
    return showBackButton ? h("calcite-action", { "aria-label": label, class: CSS$1.backButton, icon, key: "back-button", onClick: backButtonClick, ref: this.setBackRef, scale: "s", slot: SLOTS$1.headerActionsStart, text: label }) : null;
  }
  renderHeaderContent() {
  ...
  renderHeaderActionsEnd() {
    ...
    const closableNode = closable ? h("calcite-action", { "aria-label": text, icon: ICONS$1.close, onClick: close, ref: this.setCloseRef, text }) : null;
...
const FlowItem = /* @__PURE__ */ proxyCustomElement(class extends H {
  ...
  render() {
    ...
    const label = this.getBackLabel();
    return h(Host, null, h("calcite-panel", { closable, closed, description, disabled, heading, headingLevel, heightScale, intlBack, intlClose, intlOptions, loading, menuOpen, onCalcitePanelClose: this.handlePanelClose, onCalcitePanelScroll: this.handlePanelScroll, ref: this.setContainerRef, widthScale }, this.renderBackButton(), h("slot", { name: SLOTS.headerActionsStart, slot: SLOTS$1.headerActionsStart }), h("slot", { name: SLOTS.headerActionsEnd, slot: SLOTS$1.headerActionsEnd }), h("slot", { name: SLOTS.headerContent, slot: SLOTS$1.headerContent }), h("slot", { name: SLOTS.headerMenuActions, slot: SLOTS$1.headerMenuActions }), h("slot", { name: SLOTS.fab, slot: SLOTS$1.fab }), h("slot", { name: SLOTS.footerActions, slot: SLOTS$1.footerActions }), h("slot", { name: SLOTS.footer, slot: SLOTS$1.footer }), h("slot", null)), backButtonEl ? h("calcite-tooltip", { label, placement: "auto", referenceElement: backButtonEl }, label) : null);
  }
  get el() {
    return this;
  }
