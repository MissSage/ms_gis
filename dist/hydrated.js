import { a7 as w, aq as v, cp as m$1, cq as u, cr as w$1 } from "./index.js";
import "vue";
...
function a(e, n, o) {
  const i = e.hasZ(n), r2 = e.hasM(n), s2 = new w({ x: e.getPointX(n), y: e.getPointY(n), spatialReference: o });
  return i && (s2.z = e.getPointZ(n)), r2 && (s2.m = e.getPointM(n)), s2.cache._geVersion = n, s2;
}
function c(e, n, t) {
  const i = new v({ rings: e.exportPaths(n), hasZ: e.hasZ(n), hasM: e.hasM(n), spatialReference: t });
...
function x(n, t, o) {
  const i = n.hasZ(t), r2 = n.hasM(t), s2 = new w$1({ xmin: n.getXMin(t), ymin: n.getYMin(t), xmax: n.getXMax(t), ymax: n.getYMax(t), spatialReference: o });
  if (i) {
