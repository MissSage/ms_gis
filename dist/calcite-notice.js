import { gN as proxyCustomElement, gO as H, gR as createEvent, hj as setRequestedIcon, gP as h, hk as getSlotted } from "./index.js";
...
const Notice = /* @__PURE__ */ proxyCustomElement(class extends H {
  ...
  render() {
    const { el } = this;
    const closeButton = h("button", { "aria-label": this.intlClose, class: CSS.close, onClick: this.close, ref: (el2) => this.closeButton = el2 }, h("calcite-icon", { icon: "x", scale: this.scale === "l" ? "m" : "s" }));
